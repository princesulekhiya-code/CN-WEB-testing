...
const features = [
  {
    ...
    description: "Featured as a LinkedIn Top 20 Company (2023, 2024) and part of the Google AI Accelerator Batch (2024).",
    stat: "Top 20",
  ...
  },
  {
    ...
    description: "Seamless delivery across time zones with dedicated teams in India, US, and Europe.",
    stat: "10+",
  ...
  },
  {
    ...
    description: "Every engagement is backed by measurable KPIs and transparent reporting from day one.",
    stat: "100%",
  ...
  },
  {
    ...
    description: "Rapidly scale from a single developer to a full 50+ member engineering pod within weeks.",
    stat: "90+",
