...
const industries = [
  { icon: ShoppingCart, name: "E-Commerce", desc: "WooCommerce, catalogs, B2B storefronts" },
  { icon: Stethoscope, name: "Healthcare", desc: "HIPAA-aware sites, patient resources, portals" },
  { icon: GraduationCap, name: "Education", desc: "LMS integrations, courses, campus sites" },
  { icon: Building2, name: "Real Estate", desc: "Listings, IDX, agent and brokerage sites" },
  { icon: Gamepad2, name: "Media & Entertainment", desc: "Publishing, streaming, and creative brands" },
  { icon: Clock, name: "Travel", desc: "Bookings, tours, and destination marketing" },
  { icon: CreditCard, name: "Finance", desc: "Compliance-minded sites, lead gen, reporting" },
  { icon: Factory, name: "Manufacturing", desc: "B2B catalogs, distributors, technical content" },
];
...
const stats: { label: string; value: number; suffix: string; isDecimal?: boolean }[] = [
  { value: 300, suffix: "+", label: "WordPress Sites Built" },
  { value: 80, suffix: "+", label: "Happy Clients" },
  { value: 99, suffix: "%", label: "Uptime Guaranteed" },
  { value: 10, suffix: "+", label: "Years WP Experience" },
];
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Reinvent your business by developing responsive, fully-functional WordPress websites. From custom themes to headless architectures, we deliver enterprise-grade WordPress solutions.
              </p>
              <div
...
const serviceCardLogos: { logos: string[]; accent: string }[] = [
  ...
  { logos: ["wordpress/wordpress-original.svg", "html5/html5-original.svg", "css3/css3-original.svg"], accent: "#21759B" },
  { logos: ["woocommerce/woocommerce-original.svg", "wordpress/wordpress-original.svg", "php/php-original.svg"], accent: "#96588A" },
  { logos: ["php/php-original.svg", "wordpress/wordpress-original.svg", "javascript/javascript-original.svg"], accent: "#777BB4" },
  { logos: ["css3/css3-original.svg", "html5/html5-original.svg", "wordpress/wordpress-original.svg"], accent: "#E34F26" },
  { logos: ["wordpress/wordpress-original.svg", "docker/docker-original.svg", "git/git-original.svg"], accent: "#4EB3E8" },
];
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#4EB3E8]">WordPress Site?</span>
        </h2>
        <p
        ...
        >
          Tell us about your catalog, editorial team, or headless goals — we&apos;ll map a build that&apos;s fast, secure, and easy to operate.
        </p>
        <div
