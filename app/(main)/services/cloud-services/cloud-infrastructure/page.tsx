...
const techCategories = [
  { label: "Cloud Providers", items: ["AWS", "Microsoft Azure", "Google Cloud", "Oracle Cloud"] },
  { label: "Compute", items: ["EC2", "Azure VMs", "Compute Engine", "Lambda", "Fargate", "EKS"] },
  { label: "Networking", items: ["VPC", "Azure VNet", "Cloud Interconnect", "Direct Connect", "ExpressRoute"] },
  { label: "Storage", items: ["S3", "Azure Blob", "Cloud Storage", "EBS", "EFS", "Glacier"] },
  { label: "IaC & Automation", items: ["Terraform", "CloudFormation", "Pulumi", "Ansible", "CDK"] },
  { label: "Security", items: ["AWS WAF", "Azure Firewall", "Cloud Armor", "KMS", "Secrets Manager"] },
];
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Infrastructure Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Complete cloud infrastructure — from data centre design to edge computing — built for security, scale, and operational efficiency.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Infrastructure Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">From requirements through operations — a structured approach to building infrastructure you can trust.</p>
        </div>
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Infrastructure Technologies</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Enterprise cloud compute, networking, storage, and automation platforms for resilient infrastructure.</p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Infrastructure</h2>
      </div>
