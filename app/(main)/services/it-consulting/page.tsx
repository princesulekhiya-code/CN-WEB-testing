...
import {
  ArrowRight, ArrowLeft, Server, Network, ShieldCheck, Cloud,
  Headphones, Monitor, Settings, Layers, Rocket, BarChart3, TrendingUp,
  CheckCircle2, Users, Clock, HeartHandshake,
  ShoppingCart, CreditCard, Stethoscope, GraduationCap,
  Truck, Building2, Factory, Briefcase,
} from "lucide-react";
...
const techCategories: { label: string; items: { name: string; logo: string }[] }[] = [
  {
    label: "Blockchain",
    items: [
      { name: "Ethereum", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
      { name: "Hyperledger", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
      { name: "Solidity", logo: `${DEVICON}/solidity/solidity-original.svg` },
      { name: "Web3.js", logo: `${DEVICON}/javascript/javascript-original.svg` },
      { name: "Polygon", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
    ],
  },
  {
    label: "AI & ML",
    items: [
      ...
      { name: "Scikit-learn", logo: `${DEVICON}/devicon/devicon-original.svg` },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "MQTT", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "OWASP", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
                IT<br /><span className="text-[#4EB3E8]">Consulting</span>
              </h1>
...
const serviceCardLogos: { logos: string[]; accent: string }[] = [
  { logos: ["python/python-original.svg", "linux/linux-original.svg", "nodejs/nodejs-original.svg"], accent: "#4299E1" },
  { logos: ["react/react-original.svg", "amazonwebservices/amazonwebservices-plain-wordmark.svg", "docker/docker-original.svg"], accent: "#4EB3E8" },
  { logos: ["kubernetes/kubernetes-original.svg", "docker/docker-original.svg", "terraform/terraform-original.svg"], accent: "#326CE5" },
  ...
  { logos: ["react/react-original.svg", "swift/swift-original.svg", "flutter/flutter-original.svg"], accent: "#61DAFB" },
];
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Fortify Your Business for What Comes Next with<br /><span className="text-[#4EB3E8]">IT Consulting Expertise</span></h2>
        ...
        <div className={`mt-10 flex flex-col sm:flex-row gap-4 justify-center transition-all duration-700 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          <Link href="/resources/free-consultation" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg bg-[#4EB3E8] text-white font-semibold text-sm hover:bg-[#005580] transition-colors shadow-lg shadow-[#4EB3E8]/20">Request a Complimentary IT Consultation <ArrowRight className="w-4 h-4" /></Link>
