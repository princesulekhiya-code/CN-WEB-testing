...
const techCategories: { label: string; items: { name: string; logo: string }[] }[] = [
  {
    ...
    items: [
      ...
      { name: "Web3.js", logo: `${DEVICON}/web3js/web3js-original.svg` },
      { name: "Polygon", logo: `${DEVICON}/polygon/polygon-original.svg` },
    ],
  },
  {
    label: "AI & ML",
  ...
  },
  {
    label: "IoT",
    items: [
      { name: "AWS IoT", logo: `${DEVICON}/amazonwebservices/amazonwebservices-original-wordmark.svg` },
