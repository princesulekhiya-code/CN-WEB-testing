...
const heroIconItems: { icon: LucideIcon; label: string }[] = [
  { icon: Cloud, label: "Cloud" },
  { icon: Database, label: "Data" },
  { icon: ArrowUpDown, label: "Migration" },
  { icon: Server, label: "Hybrid" },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Cloud & Data
                <br />
                <span className="text-[#4EB3E8]">Migration Services</span>
              </h1>
              <p
              ...
              >
                Choose the right data migration strategy with expert guidance on cloud platform selection, cost analysis, and seamless
              ...
              >
                ...
                >
                  Get Migration Consultation <ArrowRight className="w-4 h-4" />
                </Link>
                <Link
                  href="/our-work"
              ...
              >
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Cloud migration</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Data Safe</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Full backup</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
            End-to-end migration services from strategy through optimization — ensuring your cloud journey delivers speed, savings, and
  ...
  return (
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Our <span className="text-black dark:text-white">Migration Process</span>
          </h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            A proven six-phase migration methodology that minimizes risk and ensures successful cloud adoption at every step.
          </p>
        </motion.div>
        <div className="relative">
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Migration <span className="text-black dark:text-white">Technologies</span>
          </h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
            Enterprise-grade cloud platforms, migration tools, and infrastructure-as-code solutions for seamless transitions.
          </p>
        </motion.div>
        <motion.div
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Why Choose <span className="text-black dark:text-white">Cloud Nexus</span> for Cloud Migration
          </h2>
        </motion.div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(78, 179, 232, 0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(78, 179, 232, 0.3) 1px, transparent 1px)",
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center">
        ...
        >
          Ready to Move to
          <br />
          <span className="text-[#4EB3E8]">The Cloud?</span>
        </h2>
        <p
        ...
        >
          Get a free cloud migration assessment. We&apos;ll evaluate your workloads, estimate costs, and build a migration plan tailored
          to your business.
        </p>
        <div
        ...
        >
          <Link
            href="/resources/free-consultation"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg bg-[#4EB3E8] text-white font-semibold text-sm hover:bg-[#2a8ac4] transition-colors shadow-lg shadow-[#4EB3E8]/20"
          >
            Get Migration Assessment <ArrowRight className="w-4 h-4" />
          </Link>
          <Link
            href="/our-work"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg border border-black/10 dark:border-white/10 font-semibold text-sm hover:bg-black/[0.03] dark:hover:bg-white/[0.03] transition-colors"
