...
const techCategories = [
  { label: "Discovery & Inventory", items: ["Lansweeper", "Device42", "ServiceNow CMDB", "Qualys"] },
  { label: "Security Scanning", items: ["Nessus", "Burp Suite", "Rapid7", "Tenable", "CrowdStrike"] },
  { label: "Performance Monitoring", items: ["Datadog", "Splunk", "New Relic", "Dynatrace"] },
  { label: "Compliance", items: ["Vanta", "Drata", "OneTrust", "Tugboat Logic"] },
  { label: "Network Analysis", items: ["Wireshark", "SolarWinds", "PRTG", "Nagios"] },
];
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">IT Assessment Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">End-to-end evaluation across infrastructure, security, applications, and compliance to surface risks and unlock optimization opportunities.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">A structured six-phase methodology to uncover risks, benchmark performance, and deliver actionable improvements.</p>
        </div>
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Assessment Tools & Platforms</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Industry-leading tools for discovery, scanning, monitoring, and compliance across your entire IT landscape.</p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for IT Assessments</h2>
      </div>
