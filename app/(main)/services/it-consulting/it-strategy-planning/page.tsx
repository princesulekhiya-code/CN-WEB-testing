...
const techCategories = [
  { label: "Strategy Frameworks", items: ["TOGAF", "Zachman", "ITIL 4", "COBIT", "SAFe"] },
  { label: "Portfolio Management", items: ["Jira", "Azure DevOps", "ServiceNow", "Planview"] },
  { label: "Architecture Tools", items: ["ArchiMate", "Sparx EA", "LeanIX", "Ardoq"] },
  { label: "Analytics & BI", items: ["Power BI", "Tableau", "Looker", "Snowflake"] },
  { label: "Cloud Platforms", items: ["AWS", "Azure", "GCP", "Oracle Cloud"] },
];
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">IT Strategy & Planning Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Strategic advisory that transforms IT from a cost center into a competitive advantage driving measurable business outcomes.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">A proven methodology from business alignment through execution support — ensuring strategy translates into results.</p>
        </div>
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Strategy Frameworks & Tools</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Industry-standard frameworks and modern tools that power our strategic advisory and planning engagements.</p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for IT Strategy</h2>
      </div>
