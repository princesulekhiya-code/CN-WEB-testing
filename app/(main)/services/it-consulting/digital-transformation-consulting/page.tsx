...
const techCategories = [
  { label: "Automation", items: ["UiPath", "Automation Anywhere", "Power Automate", "Zapier", "n8n"] },
  { label: "AI & Analytics", items: ["OpenAI", "Azure AI", "AWS SageMaker", "Databricks", "Snowflake"] },
  { label: "Cloud & Infrastructure", items: ["AWS", "Azure", "GCP", "Kubernetes", "Docker"] },
  { label: "Integration", items: ["MuleSoft", "Boomi", "Workato", "Postman", "GraphQL"] },
  { label: "Low-Code/No-Code", items: ["Power Apps", "OutSystems", "Mendix", "Retool", "Appian"] },
];
