...
import {
  ArrowRight, ArrowLeft, Eye, Shield, Activity, Bell,
  Radio, Search, Settings, BarChart3, Layers, Rocket,
...
const services: ServiceOffering[] = [
  { icon: Eye, title: "24/7 SIEM Monitoring", description: "Round-the-clock Security Information and Event Management monitoring with real-time log aggregation, correlation, and threat detection across your entire infrastructure.", features: ["Log aggregation", "Event correlation", "Real-time alerts"] },
  { icon: Shield, title: "Intrusion Detection & Prevention", description: "Network and host-based IDS/IPS systems that detect, block, and report malicious activity before it impacts your business operations.", features: ["Network IDS/IPS", "Host-based detection", "Auto-blocking"] },
  { icon: Radio, title: "Threat Intelligence", description: "Curated threat intelligence feeds, dark web monitoring, and indicator-of-compromise tracking to stay ahead of emerging threats targeting your industry.", features: ["Threat feeds", "Dark web monitoring", "IOC tracking"] },
  { icon: Activity, title: "Security Operations Center (SOC)", description: "Dedicated SOC team with Tier 1-3 analysts providing continuous monitoring, triage, investigation, and escalation of security events.", features: ["Tier 1-3 analysts", "Event triage", "Incident escalation"] },
  { icon: Search, title: "Log Analysis & Correlation", description: "Advanced log analysis across applications, infrastructure, and cloud services with behavioral analytics and anomaly detection for proactive threat hunting.", features: ["Behavioral analytics", "Anomaly detection", "Threat hunting"] },
  { icon: Bell, title: "Real-Time Alerting & Response", description: "Automated alerting workflows with severity-based routing, on-call escalation, and playbook-driven response procedures for rapid threat containment.", features: ["Automated workflows", "Severity routing", "Playbook response"] },
];

const processSteps = [
  { step: "01", title: "Environment Assessment", description: "Map your infrastructure, identify critical assets, and design monitoring coverage to ensure no blind spots across your technology estate.", icon: Settings },
  { step: "02", title: "SIEM Deployment", description: "Deploy and configure SIEM platform with log sources, parsers, correlation rules, and dashboards tailored to your environment.", icon: Layers },
  { step: "03", title: "Rule Development", description: "Create custom detection rules, use cases, and playbooks based on MITRE ATT&CK framework aligned to your threat profile.", icon: Shield },
  { step: "04", title: "Integration & Tuning", description: "Connect all log sources, tune alert thresholds, reduce false positives, and establish baseline behavior profiles.", icon: BarChart3 },
  { step: "05", title: "SOC Activation", description: "Activate 24/7 monitoring with trained analysts, escalation procedures, and communication channels for rapid incident response.", icon: Eye },
  { step: "06", title: "Continuous Improvement", description: "Regular rule reviews, threat landscape updates, tabletop exercises, and metrics reporting to continuously enhance detection capabilities.", icon: Rocket },
];

const techCategories = [
  { label: "SIEM Platforms", items: ["Splunk", "Microsoft Sentinel", "Elastic SIEM", "IBM QRadar", "LogRhythm"] },
  { label: "EDR/XDR", items: ["CrowdStrike", "SentinelOne", "Microsoft Defender", "Carbon Black", "Palo Alto Cortex"] },
  { label: "Threat Intel", items: ["MITRE ATT&CK", "AlienVault OTX", "VirusTotal", "Recorded Future", "Mandiant"] },
  { label: "SOAR", items: ["Palo Alto XSOAR", "Splunk SOAR", "Swimlane", "Tines", "Shuffle"] },
  { label: "Network Security", items: ["Suricata", "Zeek", "Snort", "Wireshark", "Darktrace"] },
];

const whyChoose = [
  { icon: Users, title: "Expert SOC Analysts", description: "Certified security analysts (GCIA, GCIH, OSCP) with deep experience in threat detection, investigation, and response across industries." },
  { icon: Clock, title: "24/7/365 Coverage", description: "Round-the-clock monitoring with guaranteed SLAs — because threats don't wait for business hours and neither do we." },
  { icon: TrendingUp, title: "Proactive Threat Hunting", description: "Beyond reactive monitoring — our analysts proactively hunt for threats using behavioral analytics, hypothesis-driven investigation, and threat intelligence." },
  { icon: HeartHandshake, title: "Transparent Reporting", description: "Real-time dashboards, weekly threat summaries, and monthly executive reports so you always know your security posture and ROI." },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Threat Monitoring<br /><span className="text-[#006ea3]">& SOC</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>24/7 security monitoring, intrusion detection, and real-time threat intelligence with a dedicated Security Operations Center protecting your business around the clock.</p>
...
function HeroVisual({ heroReady }: { heroReady: boolean }) {
  const items = [{ icon: Eye, label: "Monitoring" }, { icon: Shield, label: "Detection" }, { icon: Activity, label: "SOC" }, { icon: Bell, label: "Alerting" }];
