          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Cybersecurity
                <br />
                <span className="text-[#006ea3]">& Compliance</span>
              </h1>
              <p
...
const serviceCardLogos: { logos: string[]; accent: string }[] = [
  ...
  { logos: ["amazonwebservices/amazonwebservices-plain-wordmark.svg", "azure/azure-original.svg", "googlecloud/googlecloud-original.svg"], accent: "#006ea3" },
];
