...
const techCategories = [
  {
    label: "ETL/ELT",
    items: ["Apache Spark", "Airflow", "dbt", "Fivetran", "Stitch"],
  },
  {
    label: "Streaming",
    items: ["Kafka", "Flink", "Kinesis", "Pub/Sub"],
  },
  {
    label: "Storage",
    items: ["Snowflake", "Databricks", "BigQuery", "Redshift", "Delta Lake"],
  },
  {
    label: "Orchestration",
    items: ["Dagster", "Prefect", "Luigi", "Mage"],
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Data Engineering
                <br />
                <span className="text-[#006ea3]">&amp; Pipelines</span>
              </h1>
              <p
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Data Engineering Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Pipelines, platforms, and governance that turn raw signals into dependable datasets for analytics, reporting, and machine learning.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Data Engineering Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            A disciplined path from discovery to optimized production pipelines — transparent at every stage.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div
        className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Data Engineering Technologies</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Modern ETL, streaming, warehouse, and orchestration stacks we deploy and operate in production environments.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div
        className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Data Engineering</h2>
      </div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          Ready to Build Your
          <br />
          <span className="text-[#006ea3]">Data Foundation?</span>
        </h2>
        <p
