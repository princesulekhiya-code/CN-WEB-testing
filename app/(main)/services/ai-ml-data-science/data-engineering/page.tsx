...
const services: ServiceOffering[] = [
  {
    ...
    description:
      "Batch and incremental pipelines that move, transform, and validate data reliably — with idempotent jobs, schema evolution, and observability built in.",
    features: ["Batch & incremental", "Schema evolution", "Job observability"],
  },
  {
    icon: Database,
    title: "Data Lake & Warehouse Architecture",
    description:
      "Medallion lakehouse patterns, dimensional modeling, and cost-aware storage tiers so analytics teams can query confidently at any scale.",
    features: ["Medallion layers", "Dimensional models", "Cost optimization"],
  },
  {
    icon: Server,
    title: "Real-Time Streaming Pipelines",
    description:
      "Low-latency ingestion, event-time processing, and exactly-once semantics where required — from clickstreams to IoT telemetry.",
    features: ["Event-time windows", "Backpressure handling", "Exactly-once"],
  },
  {
    icon: Shield,
    title: "Data Quality & Governance",
    description:
      "Profiling, anomaly detection, lineage, and policy enforcement so stakeholders trust the numbers and auditors see a clear trail.",
    features: ["Profiling & tests", "Lineage tracking", "Policy enforcement"],
  },
  {
    icon: Layers,
    title: "Data Integration & APIs",
    description:
      "Connect SaaS, databases, and files through reusable connectors, CDC, and well-versioned APIs that keep downstream consumers stable.",
    features: ["CDC patterns", "Connector reuse", "Versioned APIs"],
  },
  {
    icon: Activity,
    title: "Cloud Data Platform Setup",
    description:
      "Landing zones, IAM, secrets, networking, and FinOps guardrails across AWS, Azure, or GCP — production-ready from day one.",
    features: ["Secure landing zones", "IAM & secrets", "FinOps guardrails"],
  },
];
...
const processSteps = [
  {
    ...
    description:
      "Inventory sources, volumes, SLAs, and compliance constraints — mapping freshness needs and ownership before design begins.",
    icon: ClipboardList,
  },
  {
    step: "02",
    ...
    description:
      "Choose lakehouse vs. warehouse patterns, partitioning strategy, and orchestration topology aligned to cost and latency targets.",
    icon: Layers,
  },
  {
    step: "03",
    ...
    description:
      "Implement ETL/ELT and streaming jobs with modular code, reusable transforms, and environment promotion from dev to production.",
    icon: Settings,
  },
  {
    step: "04",
    ...
    description:
      "Contract tests, reconciliation checks, and alerting on drift — so bad data never silently reaches dashboards or models.",
    icon: Shield,
  },
  {
    step: "05",
    ...
    description:
      "CI/CD for pipelines, infrastructure as code, and blue/green or canary patterns for safe releases with fast rollback.",
    icon: Rocket,
  },
  {
    step: "06",
    ...
    description:
      "SLI/SLO dashboards, runbook-driven incidents, and continuous tuning of cluster sizing, file layout, and spend.",
    icon: Activity,
  },
];
...
const techCategories = [
  {
    ...
    items: [
      ...
      { name: "Stitch", logo: `${DEVICON}/stitch/stitch-original.svg` }
    ],
  },
  {
    label: "Streaming",
    items: [
      ...
      { name: "Kinesis", logo: `${DEVICON}/kinesis/kinesis-original.svg` },
      { name: "Pub/Sub", logo: `${DEVICON}/pubsub/pubsub-original.svg` }
    ],
  },
  {
    label: "Storage",
  ...
  },
  {
    label: "Orchestration",
    items: [
      { name: "Dagster", logo: `${DEVICON}/dagster/dagster-original.svg` },
      { name: "Prefect", logo: `${DEVICON}/prefect/prefect-original.svg` },
      { name: "Luigi", logo: `${DEVICON}/luigi/luigi-original.svg` },
      { name: "Mage", logo: `${DEVICON}/mage/mage-original.svg` }
    ],
  },
];
...
const whyChoose = [
  {
    ...
    description:
      "Designs that grow with data volume and user concurrency — partitioning, caching, and elastic compute where it matters.",
  },
  {
    icon: Shield,
    title: "Data Quality Focus",
    description:
      "Testing and governance are first-class, not afterthoughts — fewer surprises in production analytics and ML.",
  },
  {
    icon: Server,
    title: "Cloud-Native Design",
    description:
      "Managed services, IaC, and security baselines tailored to your cloud so teams move fast without trading off control.",
  },
  {
    icon: HeartHandshake,
    title: "End-to-End Ownership",
    description:
      "From discovery through run — we stay engaged with monitoring, incidents, and roadmap planning alongside your team.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Data Engineering
                <br />
                <span className="text-[#4EB3E8]">&amp; Pipelines</span>
              </h1>
              <p
              ...
              >
                Reliable ingestion, transformation, and delivery — so your analytics and ML teams work from a single source of truth.
              </p>
              <div
              ...
              >
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">ETL Pipelines</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Big data ready</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Petabyte Scale</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Data warehousing</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Data Engineering <span className="text-black dark:text-white">Services</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Pipelines, platforms, and governance that turn raw signals into dependable datasets for analytics, reporting, and machine learning.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Our Data Engineering <span className="text-black dark:text-white">Process</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">A disciplined path from discovery to optimized production pipelines — transparent at every stage.</p>
        </motion.div>
        <div className="relative">
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Data Engineering <span className="text-black dark:text-white">Technologies</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Modern ETL, streaming, warehouse, and orchestration stacks we deploy and operate in production environments.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center">
        ...
        >
          Ready to Build Your
          <br />
          <span className="text-[#4EB3E8]">Data Foundation?</span>
        </h2>
        <p
        ...
        >
          Tell us about your sources and SLAs — we&apos;ll blueprint pipelines and a platform your teams can depend on.
        </p>
        <div
