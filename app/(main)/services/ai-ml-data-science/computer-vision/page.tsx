...
const services: ServiceOffering[] = [
  {
    ...
    description:
      "Fine-tuned CNNs and vision transformers for tagging, sorting, and routing visual content — with calibrated confidence and human-in-the-loop where needed.",
    features: ["Custom taxonomies", "Confidence calibration", "Human review hooks"],
  },
  {
    icon: Layers,
    title: "Object Detection & Tracking",
    description:
      "Bounding boxes, instance segmentation, and multi-object tracking for retail, logistics, safety, and robotics use cases at the edge or in the cloud.",
    features: ["Real-time tracking", "Multi-camera fusion", "Edge deployment"],
  },
  {
    icon: FileText,
    title: "OCR & Document Processing",
    description:
      "Layout-aware OCR, table extraction, and key-value parsing from scans and PDFs — integrated into workflows and ERP systems.",
    features: ["Layout LM", "Table extraction", "Workflow APIs"],
  },
  {
    icon: Video,
    title: "Video Analytics & Surveillance",
    description:
      "Temporal models for alerts, counting, dwell time, and anomaly detection — with privacy-preserving options and retention policies.",
    features: ["Event alerts", "Privacy controls", "Retention policies"],
  },
  {
    icon: ScanLine,
    title: "Visual Quality Inspection",
    description:
      "Defect detection, measurement, and pass/fail automation on production lines — reducing scrap while improving traceability.",
    features: ["Defect localization", "SPC integration", "Audit trails"],
  },
  {
    icon: Cpu,
    title: "Medical Image Analysis",
    description:
      "Segmentation, registration, and screening-assist models developed with clinical validation protocols and explainability in mind.",
    features: ["DICOM pipelines", "Validation protocols", "Explainability"],
  },
];
...
const processSteps = [
  {
    ...
    description:
      "Define accuracy targets, latency budgets, camera placement, and regulatory context so the solution fits operations, not the other way around.",
    icon: ClipboardList,
  },
  {
    step: "02",
    ...
    description:
      "Capture strategy, labeling guidelines, and active learning loops — maximizing label efficiency while covering edge cases.",
    icon: Images,
  },
  {
    step: "03",
    ...
    description:
      "Select backbones, heads, and training recipes matched to data volume — balancing precision, recall, and inference cost.",
    icon: Cpu,
  },
  {
    step: "04",
    ...
    description:
      "Rigorous splits, cross-validation, and bias checks — with reproducible experiments and clear promotion criteria to production.",
    icon: BarChart3,
  },
  {
    step: "05",
    ...
    description:
      "Optimized exports (ONNX, TensorRT), autoscaling APIs, and firmware integration so models run where your product needs them.",
    icon: Cloud,
  },
  {
    step: "06",
    ...
    description:
      "Drift detection, shadow deployments, and scheduled retrains — keeping vision systems accurate as scenes and SKUs evolve.",
    icon: RefreshCw,
  },
];
...
const techCategories = [
  {
    ...
    items: [
      ...
      { name: "YOLO", logo: `${DEVICON}/python/python-original.svg` },
      { name: "Detectron2", logo: `${DEVICON}/detectron2/detectron2-original.svg` }
    ],
  },
  {
    label: "Cloud Vision",
    items: [
      { name: "AWS Rekognition", logo: `${DEVICON}/awsrekognition/awsrekognition-original.svg` },
      { name: "Azure Vision", logo: `${DEVICON}/azure/azure-original.svg` },
      { name: "Google Vision", logo: `${DEVICON}/google/google-original.svg` },
      { name: "Vertex AI", logo: `${DEVICON}/vertexai/vertexai-original.svg` }
    ],
  },
  {
    label: "Edge",
    items: [
      { name: "TensorRT", logo: `${DEVICON}/tensorrt/tensorrt-original.svg` },
      { name: "ONNX Runtime", logo: `${DEVICON}/onnxruntime/onnxruntime-original.svg` },
      { name: "CoreML", logo: `${DEVICON}/apple/apple-original.svg` },
      { name: "TFLite", logo: `${DEVICON}/tflite/tflite-original.svg` }
    ],
  },
  {
    label: "Annotation",
    items: [
      { name: "Labelbox", logo: `${DEVICON}/labelbox/labelbox-original.svg` },
      { name: "V7", logo: `${DEVICON}/v7/v7-original.svg` },
      { name: "CVAT", logo: `${DEVICON}/cvat/cvat-original.svg` },
      { name: "Roboflow", logo: `${DEVICON}/roboflow/roboflow-original.svg` }
    ],
  },
];
...
const whyChoose = [
  {
    icon: Eye,
    title: "Deep CV Expertise",
    description:
      "From classical vision to modern transformers — we pick the right approach for your data, hardware, and accuracy bar.",
  },
  {
    icon: Zap,
    title: "Real-Time Performance",
    description:
      "Profiling, quantization, and kernel fusion so inference keeps up with production line speeds and interactive experiences.",
  },
  {
    icon: Cloud,
    title: "Edge & Cloud Ready",
    description:
      "One model lineage with deployment targets from GPUs in the cloud to NPUs on devices — consistent metrics everywhere.",
  },
  {
    icon: Building2,
    title: "Industry-Specific Solutions",
    description:
      "Retail, manufacturing, healthcare, and logistics patterns — not generic demos — tailored to your operational constraints.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Computer
                <br />
                <span className="text-[#4EB3E8]">Vision</span>
              </h1>
              <p
              ...
              >
                Production-grade models that interpret images and video — from quality control to intelligent customer experiences.
              </p>
              <div
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#4EB3E8]/10">
                      <Eye className="w-4 h-4 text-[#4EB3E8]" />
                    </div>
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">95% Accuracy</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Object detection</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Video processing</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
...
function HeroStats({ heroReady }: { heroReady: boolean }) {
  ...
  const items = [
    ...
    { icon: ScanLine, label: "Recognition" },
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Computer Vision <span className="text-black dark:text-white">Services</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">End-to-end vision systems — data, modeling, deployment, and monitoring — aligned to safety, latency, and regulatory expectations.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Our Computer Vision <span className="text-black dark:text-white">Process</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">From pixels to production — a transparent methodology with measurable milestones at every phase.</p>
        </motion.div>
        <div className="relative">
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Computer Vision <span className="text-black dark:text-white">Technologies</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Open-source frameworks, managed vision APIs, edge runtimes, and labeling platforms we combine for robust solutions.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#4EB3E8]">Eyes That See?</span>
        </h2>
        <p
        ...
        >
          Share your imagery goals and constraints — we&apos;ll propose a vision roadmap you can ship with confidence.
        </p>
        <div
