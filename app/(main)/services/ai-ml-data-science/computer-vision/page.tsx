...
const techCategories = [
  {
    label: "Frameworks",
    items: ["OpenCV", "TensorFlow", "PyTorch", "YOLO", "Detectron2"],
  },
  {
    label: "Cloud Vision",
    items: ["AWS Rekognition", "Azure Vision", "Google Vision", "Vertex AI"],
  },
  {
    label: "Edge",
    items: ["TensorRT", "ONNX Runtime", "CoreML", "TFLite"],
  },
  {
    label: "Annotation",
    items: ["Labelbox", "V7", "CVAT", "Roboflow"],
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Computer
                <br />
                <span className="text-[#006ea3]">Vision</span>
              </h1>
              <p
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Computer Vision Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          End-to-end vision systems — data, modeling, deployment, and monitoring — aligned to safety, latency, and regulatory expectations.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Computer Vision Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            From pixels to production — a transparent methodology with measurable milestones at every phase.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div
        className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Computer Vision Technologies</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Open-source frameworks, managed vision APIs, edge runtimes, and labeling platforms we combine for robust solutions.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div
        className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Computer Vision</h2>
      </div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#006ea3]">Eyes That See?</span>
        </h2>
        <p
