...
const techCategories = [
  {
    label: "NLP Libraries",
    items: ["spaCy", "NLTK", "Hugging Face", "Flair", "Stanza"],
  },
  {
    label: "LLM Platforms",
    items: ["OpenAI", "Anthropic", "Google PaLM", "Cohere"],
  },
  {
    label: "Chatbot Frameworks",
    items: ["Rasa", "Dialogflow", "Botpress", "Microsoft Bot"],
  },
  {
    label: "Speech",
    items: ["Whisper", "Azure Speech", "Google STT", "AWS Transcribe"],
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                NLP &amp;
                <br />
                <span className="text-[#006ea3]">Conversational AI</span>
              </h1>
              <p
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">NLP & Conversational AI Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          From classical NLP to modern LLMs — we design systems that understand your customers, employees, and documents at scale.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our NLP & Conversational AI Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            Discovery through optimization — with evaluation harnesses and governance checkpoints baked in from the start.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div
        className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">NLP & Conversational AI Technologies</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Libraries, foundation-model providers, dialog frameworks, and speech services we integrate into cohesive platforms.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div
        className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for NLP & Conversational AI</h2>
      </div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {whyChoose.map((item, i) => {
          ...
          return (
            <div
              key={item.title}
              className={`text-center p-6 rounded-2xl border border-black/[0.04] dark:border-white/[0.04] hover:border-[#006ea3]/15 transition-all duration-600 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#006ea3]">Conversations?</span>
        </h2>
        <p
