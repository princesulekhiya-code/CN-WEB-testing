...
const services: ServiceOffering[] = [
  {
    ...
    description:
      "Goal-oriented dialog systems with memory, tool use, and escalation paths — integrated into CRM, support desks, and custom web or mobile apps.",
    features: ["Tool calling", "Handoff to agents", "Omnichannel UX"],
  },
  {
    icon: Brain,
    title: "Sentiment Analysis & Opinion Mining",
    description:
      "Aspect-based sentiment, emotion detection, and trend surfacing across reviews, surveys, and social streams for product and CX teams.",
    features: ["Aspect extraction", "Emotion labels", "Trend dashboards"],
  },
  {
    icon: FileText,
    title: "Text Classification & Categorization",
    description:
      "Multi-label and hierarchical classifiers for routing tickets, moderating content, and prioritizing workflows with explainable predictions.",
    features: ["Multi-label", "Hierarchical tags", "Explainability"],
  },
  {
    icon: FileText,
    title: "Document Intelligence & Extraction",
    description:
      "Structured data from contracts, invoices, and forms — combining layout models, rules, and LLM reasoning with full audit trails.",
    features: ["Layout models", "Hybrid rules + LLM", "Audit trails"],
  },
  {
    icon: Languages,
    title: "Language Translation & Localization",
    description:
      "Adaptive MT, glossary enforcement, and in-context review workflows so global teams ship consistent messaging in every market.",
    features: ["Adaptive MT", "Glossaries", "Review workflows"],
  },
  {
    icon: MessageCircle,
    title: "Voice-Enabled Interfaces",
    description:
      "Speech-to-text, NLU, and text-to-speech pipelines for IVR modernization, hands-free apps, and accessibility-first experiences.",
    features: ["Streaming STT", "Barge-in support", "Accessibility"],
  },
];
...
const processSteps = [
  {
    ...
    description:
      "Define intents, languages, compliance needs, and success metrics — mapping user journeys before model or vendor selection.",
    icon: Target,
  },
  {
    step: "02",
    title: "Data & Corpus Preparation",
    description:
      "Clean, tokenize, de-identify, and augment text — with train/dev/test splits that reflect real traffic, not lab conditions.",
    icon: BookOpen,
  },
  {
    step: "03",
    ...
    description:
      "Choose classical, fine-tuned, or retrieval-augmented LLM stacks — benchmarked on your data with latency and cost constraints.",
    icon: Cpu,
  },
  {
    step: "04",
    title: "Intent & Entity Design",
    description:
      "Ontology design, slot filling, and disambiguation policies — so assistants stay on-brand and recover gracefully from confusion.",
    icon: GitBranch,
  },
  {
    step: "05",
    ...
    description:
      "APIs, webhooks, and channel adapters with contract tests, red-team prompts, and load testing before any public launch.",
    icon: Plug,
  },
  {
    step: "06",
    ...
    description:
      "Canary releases, analytics on resolution and containment, and continuous prompt and model updates based on live feedback.",
    icon: Rocket,
  },
];
...
const techCategories = [
  {
    ...
    items: [
      ...
      { name: "Flair", logo: `${DEVICON}/flair/flair-original.svg` },
      { name: "Stanza", logo: `${DEVICON}/stanza/stanza-original.svg` }
    ],
  },
  {
    label: "LLM Platforms",
    items: [
      ...
      { name: "Anthropic", logo: `${DEVICON}/anthropic/anthropic-original.svg` },
      { name: "Google PaLM", logo: `${DEVICON}/google/google-original.svg` },
      { name: "Cohere", logo: `${DEVICON}/cohere/cohere-original.svg` }
    ],
  },
  {
    label: "Chatbot Frameworks",
    items: [
      { name: "Rasa", logo: `${DEVICON}/python/python-original.svg` },
      { name: "Dialogflow", logo: `${DEVICON}/google/google-original.svg` },
      { name: "Botpress", logo: `${DEVICON}/python/python-original.svg` },
      { name: "Microsoft Bot", logo: `${DEVICON}/microsoftbot/microsoftbot-original.svg` }
    ],
  },
  {
    label: "Speech",
    items: [
      { name: "Whisper", logo: `${DEVICON}/whisper/whisper-original.svg` },
      { name: "Azure Speech", logo: `${DEVICON}/azure/azure-original.svg` },
      { name: "Google STT", logo: `${DEVICON}/google/google-original.svg` },
      { name: "AWS Transcribe", logo: `${DEVICON}/awstranscribe/awstranscribe-original.svg` }
    ],
  },
];
...
const whyChoose = [
  {
    ...
    description:
      "Low-resource language support, RTL layouts, and locale-aware evaluation — not English-only shortcuts.",
  },
  {
    icon: Brain,
    title: "Context-Aware AI",
    description:
      "Retrieval, memory, and business grounding so answers reflect your policies, catalogs, and knowledge bases.",
  },
  {
    icon: Shield,
    title: "Production-Grade NLP",
    description:
      "Guardrails, logging, PII handling, and SLAs designed for regulated and customer-facing deployments.",
  },
  {
    icon: HeartHandshake,
    title: "Human-Like Interactions",
    description:
      "Natural tone, empathy cues, and graceful fallbacks — assistants that feel helpful rather than robotic.",
  },
];
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Language-aware products — chatbots, search, summarization, and voice — built for accuracy, safety, and measurable business outcomes.
              </p>
              <div
              ...
              >
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#4EB3E8]/10">
                      <Brain className="w-4 h-4 text-[#4EB3E8]" />
                    </div>
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">NLP Engine</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Multi-language</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Smart Bots</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">24/7 automation</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">NLP & Conversational AI <span className="text-black dark:text-white">Services</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">From classical NLP to modern LLMs — we design systems that understand your customers, employees, and documents at scale.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Our NLP & Conversational AI <span className="text-black dark:text-white">Process</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">Discovery through optimization — with evaluation harnesses and governance checkpoints baked in from the start.</p>
        </motion.div>
        <div className="relative">
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">NLP & Conversational AI <span className="text-black dark:text-white">Technologies</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Libraries, foundation-model providers, dialog frameworks, and speech services we integrate into cohesive platforms.</p>
        </motion.div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center">
        ...
        >
          Share your channels, languages, and compliance context — we&apos;ll map a pragmatic path from pilot to production.
        </p>
        <div
