...
const techCategories: { label: string; items: { name: string; logo: string }[] }[] = [
  {
    ...
    items: [
      ...
      { name: "Golang", logo: `${DEVICON}/go/go-original.svg` },
    ],
  },
  {
    label: "Front-end",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Xamarin", logo: `${DEVICON}/xamarin/xamarin-original.svg` },
    ],
  },
  {
    label: "Database",
    items: [
      ...
      { name: "Cassandra", logo: `${DEVICON}/apache/apache-original.svg` },
    ],
  },
  {
    label: "DevOps",
    ...
    >
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#4EB3E8]/10"><Layers className="w-4 h-4 text-[#4EB3E8]" /></div>
...
const serviceCardLogos: { logos: string[]; accent: string }[] = [
  { logos: ["dotnetcore/dotnetcore-original.svg", "react/react-original.svg", "docker/docker-original.svg"], accent: "#512BD4" },
  { logos: ["nodejs/nodejs-original.svg", "react/react-original.svg", "typescript/typescript-original.svg"], accent: "#3178C6" },
  { logos: ["java/java-original.svg", "dotnetcore/dotnetcore-original.svg", "react/react-original.svg"], accent: "#5382A1" },
  { logos: ["react/react-original.svg", "nodejs/nodejs-original.svg", "postgresql/postgresql-original.svg"], accent: "#61DAFB" },
  { logos: ["react/react-original.svg", "nodejs/nodejs-original.svg", "docker/docker-original.svg"], accent: "#4EB3E8" },
  { logos: ["python/python-original.svg", "postgresql/postgresql-original.svg", "grafana/grafana-original.svg"], accent: "#3776AB" },
];
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          Ready to Build
          <br />
          <span className="text-[#4EB3E8]">Your Software?</span>
        </h2>
        <p
