...
const services: ServiceOffering[] = [
  {
    ...
    description: "Custom CRM modules for sales, marketing, support, and operations — tailored to your specific business processes and customer lifecycle.",
    features: ["Sales automation", "Marketing tools", "Support desk"],
  },
  {
    icon: Database,
    title: "CRM Data Migration",
    description: "Seamless migration from legacy CRM systems or spreadsheets with data mapping, cleansing, and validation for zero data loss.",
    features: ["Data mapping", "Zero data loss", "Legacy migration"],
  },
  {
    icon: Smartphone,
    title: "Mobile CRM Applications",
    description: "Native mobile CRM apps for field sales teams with offline access, GPS tracking, and real-time sync across all devices.",
    features: ["Offline access", "GPS tracking", "Real-time sync"],
  },
  {
    icon: Plug,
    title: "CRM Integration Services",
    description: "Connect your CRM with email, ERP, marketing automation, telephony, and third-party business tools for unified workflows.",
    features: ["Email & calendar", "ERP sync", "Marketing tools"],
  },
  {
    icon: BarChart3,
    title: "CRM Analytics & Reporting",
    description: "Custom dashboards, sales forecasting, pipeline analytics, and automated reporting for data-driven customer relationship decisions.",
    features: ["Sales forecasting", "Pipeline views", "Custom reports"],
  },
  {
    icon: Cloud,
    title: "Cloud CRM Solutions",
    description: "Scalable cloud-native CRM platforms with multi-tenant architecture, auto-scaling, and enterprise-grade security and compliance.",
    features: ["Multi-tenant", "Auto-scaling", "Cloud-native"],
  },
];
...
const techCategories = [
  { label: "CRM Platforms", items: ["Salesforce", "HubSpot", "Zoho", "Microsoft Dynamics 365", "Custom-built"] },
  { label: "Backend", items: ["Node.js", "Python Django", ".NET Core", "Java Spring", "PHP Laravel"] },
  ...
  { label: "Cloud & Tools", items: ["AWS", "Azure", "Docker", "Twilio", "SendGrid", "Zapier"] },
];
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Custom CRM Development Services</h2>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our CRM Development Process</h2>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for CRM</h2>
      </div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          Ready to Build Your
          <br />
          <span className="text-[#006ea3]">Custom CRM?</span>
        </h2>
        <p
