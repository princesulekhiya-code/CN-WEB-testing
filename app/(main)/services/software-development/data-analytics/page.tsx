...
const techCategories = [
  { label: "Data Platforms", items: ["Snowflake", "Databricks", "BigQuery", "Redshift", "Apache Spark"] },
  { label: "BI & Visualization", items: ["Tableau", "Power BI", "Looker", "Metabase", "D3.js", "Plotly"] },
  { label: "Data Engineering", items: ["Apache Airflow", "dbt", "Kafka", "Flink", "Fivetran"] },
  { label: "AI/ML", items: ["Python", "TensorFlow", "PyTorch", "scikit-learn", "MLflow", "Jupyter"] },
  { label: "Cloud & Storage", items: ["AWS S3", "Azure Data Lake", "GCS", "Delta Lake", "Iceberg"] },
];
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Data Analytics & Information Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Pipelines, warehousing, BI, predictive models, and visualization — engineered to turn your data into strategic advantage.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Data Analytics Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            From assessment to production — structured delivery with quality gates, governance, and continuous optimization.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Platforms and tools across warehousing, BI, streaming, ML, and cloud storage for reliable analytics at scale.
        </p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Data Analytics</h2>
      </div>
