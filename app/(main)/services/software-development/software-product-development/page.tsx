...
const techCategories = [
  { label: "Frontend", items: ["React", "Next.js", "Vue.js", "Flutter", "React Native", "TypeScript"] },
  { label: "Backend", items: ["Node.js", "Python", "Go", "Java", ".NET", "GraphQL"] },
  { label: "Database", items: ["PostgreSQL", "MongoDB", "Redis", "DynamoDB", "Supabase"] },
  { label: "Cloud & DevOps", items: ["AWS", "GCP", "Vercel", "Docker", "Kubernetes", "GitHub Actions"] },
  { label: "Product Tools", items: ["Figma", "Amplitude", "Mixpanel", "LaunchDarkly", "Sentry", "Datadog"] },
];
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-16">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Software Product Development Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Strategy, design, engineering, and growth — everything you need to ship and evolve a product users love.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Software Product Development Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            From discovery to launch and iteration — structured delivery with transparency, quality gates, and continuous improvement.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-16">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Modern stacks across frontend, backend, data, cloud, and product tooling for reliable, scalable software products.
        </p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-16">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Software Product Development</h2>
      </div>
