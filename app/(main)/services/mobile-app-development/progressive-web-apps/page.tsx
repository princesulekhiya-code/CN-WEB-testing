          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Progressive Web
                <br />
                <span className="text-[#006ea3]">Apps (PWA)</span>
              </h1>
              <p
...
function CTASection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#006ea3]/12 via-[#006ea3]/5 to-indigo-500/8 dark:from-[#006ea3]/8 dark:via-[#006ea3]/4 dark:to-indigo-500/6 pointer-events-none" />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#006ea3]/10 rounded-full blur-[120px] pointer-events-none" />
      <div
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          Ready to Build Your
          <br />
          <span className="text-[#006ea3]">PWA?</span>
        </h2>
        <p
