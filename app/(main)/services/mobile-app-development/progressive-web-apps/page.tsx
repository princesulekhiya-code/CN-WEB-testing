...
const techCategories = [
  ...
  { label: "Frameworks", items: ["Next.js", "React", "Angular", "Vue.js"] },
  {
    label: "PWA APIs",
    items: ["Service Workers", "Cache API", "Web Push", "IndexedDB", "Web App Manifest"],
  },
  { label: "Tools", items: ["Workbox", "Lighthouse", "PWABuilder", "Chrome DevTools"] },
  { label: "Hosting", items: ["Vercel", "Netlify", "AWS CloudFront", "Firebase Hosting"] },
];
...
function HeroVisual({ heroReady }: { heroReady: boolean }) {
  const items = [
    ...
    { icon: Radio, label: "Web Push" },
    { icon: Layers, label: "One codebase" },
  ];
  return (
    <div
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-16">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">PWA Services & Offerings</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          End-to-end progressive web apps — from first manifest line to push campaigns, performance tuning, and long-term maintenance.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our PWA Development Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            From strategy and design through deployment and optimization — a clear path to a reliable, measurable PWA.
          </p>
        </div>
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-16">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">PWA Tech Stack</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Standards-based tooling and hosting we use to ship fast, reliable progressive web apps.
        </p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-16">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for PWAs</h2>
      </div>
