...
const services: ServiceOffering[] = [
  {
    ...
    tags: ["Install prompt", "Offline shell", "App-like UX"],
  },
  {
    icon: WifiOff,
    ...
    tags: ["Service workers", "Precache strategies", "Background sync"],
  },
  {
    icon: Bell,
    ...
    tags: ["Web Push API", "VAPID & security", "Engagement flows"],
  },
  {
    icon: RefreshCw,
    title: "PWA Migration",
    ...
    tags: ["Manifest audit", "SW rollout", "Zero-downtime cutover"],
  },
  {
    icon: Gauge,
    ...
    tags: ["Lighthouse goals", "Cache API tuning", "Core Web Vitals"],
  },
  {
    icon: Settings2,
    ...
    tags: ["Release cadence", "API monitoring", "Feature roadmap"],
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Progressive Web
                <br />
                <span className="text-[#4EB3E8]">Apps (PWA)</span>
              </h1>
              <p
              ...
              >
                Deliver installable web experiences with offline support, push notifications, and app-like UX — without waiting on app store approval.
              ...
              >
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#4EB3E8]/10">
                      <Globe2 className="w-4 h-4 text-[#4EB3E8]" />
                    </div>
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Installable</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">No app store needed</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Offline-First</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Works without network</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">PWA Services & <span className="text-black dark:text-white">Offerings</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">End-to-end progressive web apps — from first manifest line to push campaigns, performance tuning, and long-term maintenance.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Our PWA Development <span className="text-black dark:text-white">Process</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">From strategy and design through deployment and optimization — a clear path to a reliable, measurable PWA.</p>
        </motion.div>
        <div className="relative">
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">PWA Tech <span className="text-black dark:text-white">Stack</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Standards-based tooling and hosting we use to ship fast, reliable progressive web apps.</p>
        </motion.div>
...
function CTASection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#4EB3E8]/12 via-[#4EB3E8]/5 to-indigo-500/8 dark:from-[#4EB3E8]/8 dark:via-[#4EB3E8]/4 dark:to-indigo-500/6 pointer-events-none" />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#4EB3E8]/10 rounded-full blur-[120px] pointer-events-none" />
      <div
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center">
        ...
        >
          Let us help you ship an installable, offline-ready web app with push notifications and performance that rivals native — without the app store gate.
        </p>
        <div
