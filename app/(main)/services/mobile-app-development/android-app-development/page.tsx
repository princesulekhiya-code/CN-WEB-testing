...
const techCategories = [
  { label: "Languages", items: ["Kotlin", "Java", "XML"] },
  { label: "IDE & Tools", items: ["Android Studio", "Gradle", "ADB", "ProGuard"] },
  { label: "Frameworks", items: ["Jetpack Compose", "Room", "Retrofit", "Dagger/Hilt", "Navigation"] },
  { label: "Backend", items: ["Firebase", "Node.js", "GraphQL", "REST APIs", "AWS"] },
  { label: "Testing", items: ["JUnit", "Espresso", "Mockito", "Firebase Test Lab"] },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="max-w-3xl">
            ...
            <p
              className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-2xl transition-all duration-700 delay-200 ${
    ...
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Full-spectrum Android delivery — from native apps and tablets to Wear OS, ASO, and long-term maintenance.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Development Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            A clear six-step path from discovery to Play Store and beyond — aligned with how great Android products ship.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          The languages, tools, and libraries we use to ship reliable Android products.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
          Partner with a team that treats your Play Store launch and long-term success as seriously as you do.
        </p>
      </div>
