...
const techStack = [
  { label: "Languages", items: [
      { name: "JavaScript", logo: `${DEVICON}/javascript/javascript-original.svg` },
      { name: "TypeScript", logo: `${DEVICON}/typescript/typescript-original.svg` },
      { name: "JSX", logo: `${DEVICON}/jsx/jsx-original.svg` }
    ] },
  { label: "Tools", items: [
      { name: "Expo", logo: `${DEVICON}/react/react-original.svg` },
      { name: "React Native CLI", logo: `${DEVICON}/react/react-original.svg` },
      { name: "Metro", logo: `${DEVICON}/metro/metro-original.svg` },
      { name: "Flipper", logo: `${DEVICON}/flipper/flipper-original.svg` }
    ] },
  {
    label: "Libraries",
    items: [
      ...
      { name: "React Navigation", logo: `${DEVICON}/reactnavigation/reactnavigation-original.svg` },
      { name: "React Query", logo: `${DEVICON}/react/react-original.svg` },
      { name: "Reanimated", logo: `${DEVICON}/reanimated/reanimated-original.svg` }
    ],
  },
  {
    label: "Backend",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "React Native Testing Library", logo: `${DEVICON}/react/react-original.svg` }
    ],
  },
];
          ...
          <div className="space-y-6">
            ...
            >
              <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl shadow-black/10 dark:shadow-black/40 border border-black/[0.06] dark:border-white/[0.06]">
                <Image
                  src="https://images.unsplash.com/photo-1555774698-0b77e0d5fac6?w=800&h=600&fit=crop&q=80"
              ...
              <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-black dark:text-white">JS & TypeScript</div>
                    <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Cross-platform</div>
                  </div>
                </div>
              </motion.div>
              <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-black dark:text-white">Hot Reload</div>
                    <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Instant iterations</div>
                  </div>
                </div>
              </motion.div>
            </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">Discovery through support — a clear six-step timeline so you always know where the project stands.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Languages, tooling, libraries, backends, and testing — chosen for maintainable React Native products at scale.</p>
        </motion.div>
