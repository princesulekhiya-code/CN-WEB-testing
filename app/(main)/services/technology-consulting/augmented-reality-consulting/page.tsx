...
import {
  ...
  Award, HeartHandshake, ClipboardList, Rocket, Settings, Palette, ShieldCheck,
} from "lucide-react";
...
const DEVICON_FALLBACK = `${DEVICON}/devicon/devicon-original.svg`;
...
const TECH_SVG: Record<string, string> = {
  ARKit: "apple/apple-original.svg",
  ARCore: "android/android-original.svg",
  ...
  "WebXR": "javascript/javascript-original.svg",
  AWS: "amazonwebservices/amazonwebservices-plain-wordmark.svg",
  "Azure Spatial Anchors": "azure/azure-original.svg",
  "Google Cloud": "googlecloud/googlecloud-original.svg",
  Firebase: "firebase/firebase-original.svg",
  "8th Wall": "devicon/devicon-original.svg",
  Vuforia: "devicon/devicon-original.svg",
  "Spark AR": "devicon/devicon-original.svg",
  "A-Frame": "aframe/aframe-original.svg",
  Zappar: "devicon/devicon-original.svg",
};

function techItem(name: string): { name: string; logo: string } {
  const path = TECH_SVG[name];
  return { name, logo: path ? `${DEVICON}/${path}` : DEVICON_FALLBACK };
}
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Augmented Reality<br /><span className="text-[#4EB3E8]">Consulting</span></h1>
              ...
              >
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">AR/VR Expert</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Immersive tech</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Innovation</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Cutting-edge</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
...
function HeroStats({ heroReady }: { heroReady: boolean }) {
  ...
  const items = [{ icon: Glasses, label: "AR/VR" }, { icon: Package, label: "3D Models" }, { icon: Smartphone, label: "Mobile AR" }, { icon: Layers, label: "Spatial" }];
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">AR Consulting <span className="text-black dark:text-white">Services</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">End-to-end augmented reality solutions from strategy and 3D design to development and launch.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Our AR Development <span className="text-black dark:text-white">Process</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">From concept to launch — structured delivery for immersive AR experiences.</p>
        </motion.div>
        <div className="relative">
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">AR SDKs, 3D pipelines, WebAR, and cloud tools we use to build immersive AR products.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-3 text-sm font-medium text-black/40 dark:text-white/40 max-w-2xl mx-auto">We deliver AR consulting that is measured, user-centered, and ready for production.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          Ready to Bring Your Brand to Life with
          <br />
          <span className="text-[#4EB3E8]">Augmented Reality?</span>
        </h2>
        <p className={`mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-xl mx-auto leading-relaxed transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          Let us create immersive AR experiences that captivate your audience and deliver measurable business results.
        </p>
