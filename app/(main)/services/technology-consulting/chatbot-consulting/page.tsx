...
import {
  ArrowRight, ArrowLeft, MessageSquare, Users, Zap, MessageCircle,
  CheckCircle2, HelpCircle, Palette, Globe, BarChart3, Mic,
  Award, ShieldCheck, HeartHandshake, ClipboardList, Rocket, Settings, Layers,
} from "lucide-react";
...
const services: ServiceOffering[] = [
  { icon: MessageSquare, title: "AI-Powered Chatbot Development", description: "Intelligent conversational agents powered by NLP and machine learning that understand context and intent.", features: ["NLP-powered", "Context awareness", "Multi-turn dialogs"] },
...
const processSteps = [
  { step: "01", title: "Requirements Analysis", description: "Understanding your support workflows, user intents, and integration requirements for the chatbot.", icon: ClipboardList },
...
const techCategories = [
  { label: "Bot Frameworks", items: ["Dialogflow", "Rasa", "Microsoft Bot Framework", "Amazon Lex"] },
  { label: "AI/NLP", items: ["OpenAI", "LangChain", "Hugging Face", "spaCy", "NLTK"] },
  { label: "Channels", items: ["WhatsApp API", "Slack", "Microsoft Teams", "Facebook Messenger", "Web Widget"] },
  { label: "Analytics", items: ["Dashbot", "Botanalytics", "Google Analytics", "Custom Dashboards"] },
];

const whyChoose = [
  { icon: Award, title: "NLP & AI Expertise", description: "Deep expertise in natural language processing, transformer models, and conversational AI architectures." },
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Chatbot<br /><span className="text-[#4EB3E8]">Consulting</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Create tailored chatbots for enhanced customer support, higher conversions, and personalized experiences that optimize operational efficiency.</p>
            ...
            <div className={`grid grid-cols-2 gap-4 transition-all duration-700 delay-300 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              {[{ icon: MessageSquare, label: "Chatbots" }, { icon: Users, label: "Support" }, { icon: Zap, label: "Automation" }, { icon: MessageCircle, label: "AI Bots" }].map((item, i) => { const Icon = item.icon; return (
