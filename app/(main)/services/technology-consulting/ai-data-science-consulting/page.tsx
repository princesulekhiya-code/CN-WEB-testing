...
import {
  ArrowRight, ArrowLeft, Brain, Zap, LineChart, Cpu,
  CheckCircle2, MessageSquare, Eye, Target, Settings,
  Award, ShieldCheck, HeartHandshake, ClipboardList, Rocket, Layers, BarChart3,
} from "lucide-react";
...
const services: ServiceOffering[] = [
  { icon: Brain, title: "Machine Learning Solutions", description: "Custom ML models for classification, prediction, and recommendation that drive business outcomes from your data.", features: ["Custom models", "Feature engineering", "Model optimization"] },
  { icon: MessageSquare, title: "Natural Language Processing", description: "Text analysis, chatbots, sentiment analysis, and document processing powered by state-of-the-art NLP models.", features: ["Text analytics", "Sentiment analysis", "Document AI"] },
  { icon: Eye, title: "Computer Vision", description: "Image recognition, object detection, and video analytics solutions for manufacturing, retail, and security.", features: ["Object detection", "Image classification", "Video analytics"] },
  { icon: LineChart, title: "Predictive Analytics", description: "Forecasting, trend analysis, and demand prediction models that help businesses anticipate and prepare for the future.", features: ["Time-series forecasting", "Risk scoring", "Demand prediction"] },
  { icon: Target, title: "AI Strategy & Roadmap", description: "AI readiness assessment, use case identification, and implementation planning to maximize AI investment returns.", features: ["Readiness assessment", "Use case mapping", "ROI projection"] },
  { icon: Settings, title: "MLOps & Model Deployment", description: "Model lifecycle management, monitoring, and production deployment ensuring reliable AI at enterprise scale.", features: ["CI/CD for ML", "Model monitoring", "A/B testing"] },
];

const processSteps = [
  { step: "01", title: "AI Readiness Assessment", description: "Evaluate data maturity, infrastructure, team capabilities, and identify high-impact AI use cases.", icon: ClipboardList },
  { step: "02", title: "Data Preparation", description: "Data collection, cleaning, feature engineering, and pipeline setup for reliable model training.", icon: Layers },
  { step: "03", title: "Model Development", description: "Algorithm selection, model architecture design, and iterative development with cross-validation.", icon: Brain },
  { step: "04", title: "Training & Validation", description: "Distributed training, hyperparameter tuning, and rigorous validation against business metrics.", icon: BarChart3 },
  { step: "05", title: "Deployment & Integration", description: "Containerized model serving, API endpoints, and seamless integration with existing systems.", icon: Rocket },
  { step: "06", title: "Monitoring & Optimization", description: "Model drift detection, performance monitoring, retraining pipelines, and continuous improvement.", icon: Settings },
];

const techCategories = [
  { label: "ML Frameworks", items: ["TensorFlow", "PyTorch", "scikit-learn", "Keras", "XGBoost"] },
  { label: "NLP & LLM", items: ["Hugging Face", "OpenAI", "LangChain", "spaCy", "NLTK"] },
  { label: "Cloud ML", items: ["AWS SageMaker", "Azure ML", "Vertex AI", "Databricks"] },
  { label: "Languages", items: ["Python", "R", "Julia", "SQL", "Scala"] },
];

const whyChoose = [
  { icon: Award, title: "PhD-Level AI Experts", description: "Data scientists and ML engineers with advanced degrees and production-scale AI experience." },
  { icon: Rocket, title: "Production-Ready Models", description: "Models built for production from day one — scalable, monitored, and maintainable." },
  { icon: ShieldCheck, title: "Ethical AI Practices", description: "Bias detection, explainability, and responsible AI frameworks baked into every project." },
  { icon: HeartHandshake, title: "Measurable Business Impact", description: "Every AI solution tied to clear business KPIs with transparent ROI tracking." },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>AI & Data Science<br /><span className="text-[#006ea3]">Consulting</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Implement advanced algorithms, predictive analytics, and intelligent automation to drive innovation and competitive advantage.</p>
...
function HeroVisual({ heroReady }: { heroReady: boolean }) {
  const items = [{ icon: Brain, label: "AI/ML" }, { icon: Zap, label: "Automation" }, { icon: LineChart, label: "Analytics" }, { icon: Cpu, label: "Deep Learning" }];
