    ...
    <section className="min-h-screen bg-white text-black dark:bg-black dark:text-white">
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          >
            <ArrowLeft size={16} /> Back to Technology Consulting
          </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                AI & Data Science
                <br />
                <span className="text-[#4EB3E8]">Consulting</span>
              </h1>
              <p
              ...
              >
                Implement advanced algorithms, predictive analytics, and intelligent automation to drive innovation and competitive
                advantage.
              </p>
              <div
              ...
              >
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">AI Advisory</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">ML strategy</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">ROI Focused</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Business impact</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            AI & Data Science <span className="text-black dark:text-white">Services</span>
          </h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
            End-to-end AI solutions from strategy and model development to deployment and monitoring.
          </p>
        </motion.div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Our AI <span className="text-black dark:text-white">Consulting Process</span>
          </h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            From assessment to production — structured AI delivery with measurable outcomes.
          </p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
            Industry-leading AI/ML frameworks, cloud platforms, and programming languages.
          </p>
        </motion.div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Why Choose <span className="text-black dark:text-white">Cloud Nexus</span> for AI & Data Science
          </h2>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#4EB3E8]">Artificial Intelligence?</span>
        </h2>
        <p
        ...
        >
          Let us build AI solutions that drive real business outcomes — from predictive models to intelligent automation.
        </p>
        <div
