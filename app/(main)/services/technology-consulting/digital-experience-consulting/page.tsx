...
const techCategories = [
  { label: "UX Tools", items: ["Figma", "Adobe XD", "Sketch", "InVision", "Miro"] },
  { label: "Analytics", items: ["Hotjar", "FullStory", "Google Analytics", "Mixpanel", "Amplitude"] },
  { label: "Testing", items: ["Optimizely", "VWO", "UserTesting", "Maze", "Lookback"] },
  { label: "Development", items: ["React", "Next.js", "Tailwind CSS", "Storybook", "Chromatic"] },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Digital Experience<br /><span className="text-[#006ea3]">Consulting</span></h1>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Ready to Transform Your<br /><span className="text-[#006ea3]">Digital Experience?</span></h2>
