...
import {
  ArrowRight, ArrowLeft, Monitor, Palette, Users, Zap,
  CheckCircle2, Layers, TrendingUp, ShieldCheck,
  HeartHandshake, Award, Settings, Rocket, ClipboardList, BarChart3,
} from "lucide-react";
...
const services: ServiceOffering[] = [
  { icon: Monitor, title: "UX Strategy & Audit", description: "UX research, heuristic audits, and strategic recommendations to transform your digital presence into a conversion engine.", features: ["Heuristic evaluation", "Usability testing", "UX benchmarking"] },
...
const processSteps = [
  { step: "01", title: "Discovery & Research", description: "Stakeholder interviews, analytics review, competitive analysis, and user research to understand the current state.", icon: ClipboardList },
...
const whyChoose = [
  { icon: Award, title: "UX Research Experts", description: "Certified UX researchers and designers with deep expertise in user-centered design methodologies." },
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Digital Experience<br /><span className="text-[#4EB3E8]">Consulting</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Strategic planning to build conversion-oriented digital solutions with immersive user experiences that attract and retain customers.</p>
              ...
              >
                <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl shadow-black/10 dark:shadow-black/40 border border-black/[0.06] dark:border-white/[0.06]">
                  <Image
                    ...
                    alt="Digital Experience Consulting"
                    fill
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">DX Expert</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Digital experience</div>
                    </div>
                  </div>
                </motion.div>
...
function HeroStats({ heroReady }: { heroReady: boolean }) {
  ...
  const items = [{ icon: Monitor, label: "UX Strategy" }, { icon: Palette, label: "Design" }, { icon: Users, label: "Users" }, { icon: Zap, label: "Performance" }];
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Digital Experience Consulting <span className="text-black dark:text-white">Services</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Comprehensive UX strategy and design consulting to create digital experiences that convert and delight.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Our Digital Experience <span className="text-black dark:text-white">Process</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">From discovery to optimization — a proven methodology for creating exceptional digital experiences.</p>
        </motion.div>
        <div className="relative">
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Industry-leading UX tools, analytics platforms, and testing frameworks.</p>
        </motion.div>
