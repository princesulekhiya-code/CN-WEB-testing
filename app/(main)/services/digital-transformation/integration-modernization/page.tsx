...
const techCategories = [
  { label: "API", items: ["REST", "GraphQL", "gRPC", "WebSocket", "OpenAPI"] },
  { label: "iPaaS", items: ["MuleSoft", "Dell Boomi", "Workato", "Zapier", "n8n"] },
  { label: "Messaging", items: ["Apache Kafka", "RabbitMQ", "AWS SNS-SQS", "Redis Streams", "NATS"] },
  { label: "Protocols", items: ["HTTP-2", "MQTT", "AMQP", "WebSocket", "Server-Sent Events"] },
  { label: "Monitoring", items: ["Datadog", "New Relic", "Prometheus", "Grafana", "ELK"] },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Integration<br /><span className="text-[#006ea3]">Modernization</span></h1>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Integration Modernization Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Gateways, iPaaS, streaming, and automation — engineered for reliability across your enterprise footprint.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Integration Modernization Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">Audit through operations — a playbook for dependable enterprise connectivity.</p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">API styles, iPaaS platforms, messaging, protocols, and observability for enterprise integrations.</p>
      </div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Ready to Modernize Your<br /><span className="text-[#006ea3]">Integrations?</span></h2>
