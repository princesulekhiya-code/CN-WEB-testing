...
const techCategories = [
  { label: "Languages", items: ["TypeScript", "Python", "Go", "Rust", "Java"] },
  { label: "Frameworks", items: ["React", "Next.js", "Node.js", "Django", "Spring Boot"] },
  { label: "Database", items: ["PostgreSQL", "MongoDB", "Redis", "Elasticsearch", "Neo4j"] },
  { label: "Testing", items: ["Jest", "Cypress", "Playwright", "JMeter", "k6"] },
  { label: "DevOps", items: ["Docker", "Kubernetes", "GitHub Actions", "Terraform", "ArgoCD"] },
];
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-16">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Product Re-engineering Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Modernize legacy products with disciplined refactoring, performance work, and secure delivery practices.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Product Re-engineering Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">Assessment through release — structured delivery that balances velocity with stability.</p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-16">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Languages, frameworks, data stores, testing, and DevOps aligned to maintainable product delivery.</p>
      </div>
