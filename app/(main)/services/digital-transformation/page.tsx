    ...
    <div className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className={`inline-block text-xs font-bold tracking-widest text-[#4EB3E8] uppercase mb-4 transition-all duration-500 ${ready ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
              Propel Innovation
            </span>
            <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${ready ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
              ...
              <span className="text-[#4EB3E8]">& Transformation</span>
            </h1>
...
const serviceCardLogos: { logos: string[]; accent: string }[] = [
  ...
  { logos: ["react/react-original.svg", "typescript/typescript-original.svg", "nextjs/nextjs-original.svg"], accent: "#4EB3E8" },
];
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          Ready to Transform<br /><span className="text-[#4EB3E8]">Your Business?</span>
        </h2>
