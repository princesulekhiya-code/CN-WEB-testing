...
const industries = [
  { icon: Stethoscope, name: "Healthcare", desc: "Digital health, patient portals" },
  { icon: ShoppingCart, name: "Retail", desc: "Omnichannel, e-commerce modernization" },
  { icon: CreditCard, name: "Finance", desc: "Digital banking, fintech platforms" },
  { icon: Truck, name: "Logistics", desc: "Supply chain, fleet automation" },
  { icon: GraduationCap, name: "Education", desc: "EdTech, LMS modernization" },
  { icon: Building2, name: "Real Estate", desc: "PropTech, smart buildings" },
