          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Responsive Website
                <br />
                <span className="text-[#4EB3E8]">Design</span>
              </h1>
              <p
              ...
              >
                Pixel-perfect responsive websites that adapt seamlessly to every screen size with mobile-first
                approach.
              </p>
              <div
            ...
            <HeroColumn heroReady={heroReady} />
          </div>
        </div>
      </div>
...
function HeroColumn({ heroReady }: { heroReady: boolean }) {
  return (
...
function HeroStatsBar() {
  ...
  return (
    <div ref={ref} className="w-full">
      <motion.div
        className={`grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 ${visible ? "opacity-100" : "opacity-0"}`}
        initial={false}
      ...
      >
        {stats.map((stat, i) => (
          <div
            key={stat.label}
            className="text-center rounded-xl border border-[#4EB3E8]/10 bg-gradient-to-b from-[#4EB3E8]/[0.04] to-transparent dark:from-[#4EB3E8]/[0.06] px-2 py-3 sm:px-3 sm:py-4"
          >
            <div className="text-lg sm:text-xl md:text-2xl font-bold text-[#4EB3E8] tabular-nums">
              {counts[i]}
              {stat.suffix}
            </div>
            <div className="mt-0.5 text-[9px] sm:text-[10px] md:text-xs font-medium text-black/40 dark:text-white/40 leading-tight">
              {stat.label}
            </div>
          </div>
        ))}
              ...
              >
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Responsive</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">All devices</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Pixel Perfect</div>
...
const serviceCardLogos: { logos: string[]; accent: string }[] = [
  { logos: ["html5/html5-original.svg", "css3/css3-original.svg", "tailwindcss/tailwindcss-original.svg"], accent: "#4EB3E8" },
  { logos: ["chrome/chrome-original.svg", "firefox/firefox-original.svg", "sass/sass-original.svg"], accent: "#4EB3E8" },
  { logos: ["figma/figma-original.svg", "react/react-original.svg", "nextjs/nextjs-original.svg"], accent: "#4EB3E8" },
  { logos: ["html5/html5-original.svg", "css3/css3-original.svg", "javascript/javascript-original.svg"], accent: "#4EB3E8" },
  { logos: ["bootstrap/bootstrap-original.svg", "webpack/webpack-original.svg", "wordpress/wordpress-original.svg"], accent: "#4EB3E8" },
  { logos: ["webpack/webpack-original.svg", "vite/vite-original.svg", "google/google-original.svg"], accent: "#4EB3E8" },
];
...
function ServiceCardIllustration({ index }: { index: number }) {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div
        className="absolute top-5 left-14 w-2 h-2 rounded-full opacity-20 group-hover:opacity-50 transition-opacity duration-500"
        style={{ backgroundColor: data.accent }}
      />
      <div
        className="absolute bottom-8 right-14 w-1.5 h-1.5 rounded-full opacity-15 group-hover:opacity-40 transition-opacity duration-500"
        style={{ backgroundColor: data.accent }}
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Responsive Website Design <span className="text-black dark:text-white">Services</span>
          </h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
            Adaptive experiences from mobile to desktop — performance, accessibility, and visual polish at every
            breakpoint.
          </p>
        </motion.div>
                ...
                <div className="group relative h-full rounded-2xl border border-black/[0.06] bg-white/80 dark:bg-white/[0.02] hover:border-[#4EB3E8]/30 hover:bg-[#4EB3E8]/[0.02] hover:-translate-y-1.5 hover:shadow-xl hover:shadow-[#4EB3E8]/5 transition-all duration-500 dark:border-white/[0.06] dark:hover:border-[#4EB3E8]/30 dark:hover:bg-[#4EB3E8]/[0.04] overflow-hidden">
                  ...
                  <div className="relative h-36 md:h-40 overflow-hidden rounded-t-2xl bg-gradient-to-br from-[#4EB3E8]/[0.03] via-transparent to-[#4EB3E8]/[0.02] dark:from-[#4EB3E8]/[0.05] dark:to-[#4EB3E8]/[0.02] border-b border-black/[0.04] dark:border-white/[0.04] group-hover:from-[#4EB3E8]/[0.06] group-hover:to-[#4EB3E8]/[0.03] transition-all duration-500">
                    ...
                    <div className="absolute top-3 right-3 flex h-8 w-8 items-center justify-center rounded-lg bg-white/80 dark:bg-black/40 border border-black/[0.06] dark:border-white/[0.06] backdrop-blur-sm group-hover:bg-[#4EB3E8]/10 group-hover:border-[#4EB3E8]/20 transition-all duration-300">
                      <Icon
                        className="w-4 h-4 text-black/50 dark:text-white/50 group-hover:text-[#4EB3E8] transition-colors duration-300"
                        strokeWidth={1.5}
                      />
                    </div>
                  </div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Our Responsive Website Design <span className="text-black dark:text-white">Process</span>
          </h2>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Technologies <span className="text-black dark:text-white">We Use</span>
          </h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Why Choose Cloud Nexus for <span className="text-black dark:text-white">Responsive Website Design</span>
          </h2>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center">
        ...
        >
          Ready for a
          <br />
          <span className="text-[#4EB3E8]">Responsive Website?</span>
        </motion.h2>
        <motion.p
        ...
        >
          Partner with us for mobile-first design, cross-browser confidence, and Core Web Vitals that stay green in
          production.
        </motion.p>
        <motion.div
