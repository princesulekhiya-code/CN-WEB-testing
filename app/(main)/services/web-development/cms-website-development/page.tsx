...
const services: ServiceOffering[] = [
  {
    ...
    description: "Custom themes, performance tuning, and enterprise-grade WordPress builds with clean, maintainable PHP and modern tooling.",
    features: ["Custom themes", "Performance", "Gutenberg blocks"],
  },
  {
    icon: Globe,
    title: "Headless CMS Development",
    description: "Decoupled frontends with a CMS as the content hub — fast pages, flexible models, and omnichannel publishing.",
    features: ["Next.js frontends", "Preview & drafts", "CDN-friendly"],
  },
  {
    icon: Layers,
    title: "Strapi Development",
    description: "Self-hosted or cloud Strapi with roles, workflows, and APIs tailored to your editorial and engineering teams.",
    features: ["Roles & permissions", "Plugins", "GraphQL/REST"],
  },
  {
    icon: RefreshCw,
    title: "CMS Migration",
    description: "Content mapping, URL preservation, SEO continuity, and validation scripts so migrations finish without surprises.",
    features: ["URL mapping", "Redirects", "QA checkpoints"],
  },
  {
    icon: Code2,
    title: "Custom Plugin Development",
    description: "Plugins and modules for WordPress, Strapi, and PHP/Node ecosystems — secure, versioned, and documented.",
    features: ["Secure coding", "Versioning", "Docs & handoff"],
  },
  {
    icon: Wrench,
    title: "CMS Maintenance & Support",
    description: "Updates, backups, uptime monitoring, and editorial support so your CMS stays fast, safe, and easy to use.",
...
const processSteps = [
  {
    step: "01",
    title: "Audit",
    description: "Inventory content types, integrations, SEO footprint, and editorial pain points to guide the rebuild.",
    icon: ClipboardList,
  },
  {
    step: "02",
    title: "CMS Selection",
    description: "Pick WordPress, Strapi, Sanity, or headless stacks based on workflows, scale, and total cost of ownership.",
    icon: Layers,
  },
  {
    step: "03",
    title: "Design",
    description: "Information architecture, templates, and component libraries that keep publishing consistent and on-brand.",
    icon: Palette,
  },
  {
    step: "04",
...
const techCategories = [
  { label: "CMS Platforms", items: ["WordPress", "Strapi", "Sanity", "Contentful", "Ghost"] },
  { label: "Frontend", items: ["React", "Next.js", "PHP", "Twig"] },
  { label: "Backend", items: ["PHP", "Node.js", "GraphQL", "REST APIs"] },
  { label: "Database", items: ["MySQL", "PostgreSQL", "MongoDB"] },
  { label: "Tools", items: ["ACF", "Elementor", "WPBakery", "Yoast SEO"] },
];
...
const whyChoose = [
  {
    ...
    description: "Teams that ship editorial-friendly systems — not generic sites — with workflows that match how you work.",
  },
  {
    icon: TrendingUp,
    title: "SEO Optimized",
    description: "Structured data, clean URLs, redirects, and performance budgets aligned with search best practices.",
  },
  {
    icon: Zap,
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Content management systems on WordPress, Strapi, Sanity, or headless CMS platforms for easy content updates.
              </p>
              <div
...
function HeroVisual({ heroReady }: { heroReady: boolean }) {
  const items = [
    { icon: FileCode2, label: "WordPress" },
    { icon: Layers, label: "Headless" },
    { icon: Settings, label: "Custom CMS" },
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">CMS Website Development Services</h2>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our CMS Website Development Process</h2>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for CMS Website Development</h2>
      </div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          Ready to Build Your
          <br />
          <span className="text-[#006ea3]">CMS Website?</span>
        </h2>
        <p
        ...
        >
          Partner with us for editor-friendly CMS builds, SEO-conscious migrations, and dependable support after launch.
        </p>
        <div
