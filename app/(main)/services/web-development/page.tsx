...
import {
  ArrowRight, ArrowLeft, Globe, Zap, Search, ShieldCheck, BarChart3, Code2,
  Layers, Palette, Settings, Rocket, CheckCircle2, Users, Clock,
  HeartHandshake, Monitor, FileCode2, Smartphone, ShoppingCart,
  CreditCard, Stethoscope, GraduationCap, Truck, Building2, Factory, Gamepad2,
} from "lucide-react";
...
const services: ServiceOffering[] = [
  {
    ...
    description: "Bespoke, high-performance websites tailored to your exact business requirements with 3rd-party integrations and custom functionality.",
    features: ["Tailored solutions", "API integrations", "Scalable architecture"],
    href: "/services/web-development/custom-website-development",
  },
  {
    icon: FileCode2,
    title: "CMS Website Development",
    description: "Content management systems built on WordPress, Strapi, or headless CMS platforms for easy content updates and management.",
    features: ["WordPress & Strapi", "Headless CMS", "Easy content management"],
    href: "/services/web-development/cms-website-development",
  },
  {
    icon: Smartphone,
    title: "Responsive Website Design",
    description: "Pixel-perfect responsive websites that adapt seamlessly to every screen size — desktop, tablet, and mobile.",
    features: ["Mobile-first design", "Cross-browser", "Adaptive layouts"],
    href: "/services/web-development/responsive-website-design",
  },
  {
    icon: ShoppingCart,
    title: "E-Commerce Website Development",
    description: "Scalable online stores with payment gateways, inventory management, and conversion-optimized shopping experiences.",
    features: ["Payment integration", "Product catalogs", "Multi-currency"],
    href: "/services/web-development/ecommerce-website-development",
  },
  {
    icon: Zap,
    title: "Single Page App Development",
    description: "Lightning-fast SPAs with seamless navigation, quick load speeds, and dynamic content — built for modern user experiences.",
    features: ["React & Next.js", "Instant navigation", "Dynamic content"],
    href: "/services/web-development/single-page-app-development",
  },
  {
    icon: Globe,
    title: "Progressive Web App Development",
    description: "Installable, offline-capable web apps with push notifications and app-like experiences — no app store required.",
    features: ["Offline-first", "Push notifications", "Installable"],
    href: "/services/web-development/progressive-web-app-development",
  },
];

const processSteps = [
  { step: "01", title: "Strategy & Research", description: "Market research, competitor analysis, business goals definition, and feature roadmap planning.", icon: BarChart3 },
  { step: "02", title: "Analysis & Planning", description: "Risk analysis, functionality structuring, SRS documentation, and MVP definition.", icon: Settings },
  { step: "03", title: "UI/UX Design", description: "Information architecture, wireframing, interactive prototyping, and design system creation.", icon: Palette },
  { step: "04", title: "Website Development", description: "Technology stack selection, front-end and back-end development with CI/CD pipelines.", icon: Code2 },
  { step: "05", title: "QA & Testing", description: "User experience, functional, performance, security, and cross-browser testing.", icon: ShieldCheck },
  { step: "06", title: "Deployment & Support", description: "Cloud deployment, metadata preparation, performance monitoring, and ongoing support.", icon: Rocket },
];
...
const techCategories: { label: string; items: { name: string; logo: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "ASP.NET", logo: `${DEVICON}/dotnetcore/dotnetcore-original.svg` },
    ],
  },
  {
    label: "Database",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Sanity", logo: `${DEVICON}/devicon/devicon-original.svg` },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Illustrator", logo: `${DEVICON}/illustrator/illustrator-plain.svg` },
...
const industries = [
  { icon: Stethoscope, name: "Healthcare", desc: "Patient portals, telemedicine platforms" },
  { icon: ShoppingCart, name: "E-Commerce", desc: "Online stores, marketplaces" },
  { icon: CreditCard, name: "FinTech", desc: "Dashboards, payment platforms" },
  { icon: GraduationCap, name: "Education", desc: "LMS, e-learning platforms" },
  { icon: Truck, name: "Logistics", desc: "Tracking, fleet management" },
  { icon: Building2, name: "Real Estate", desc: "Property listings, portals" },
  { icon: Factory, name: "Manufacturing", desc: "ERP, inventory systems" },
  { icon: Gamepad2, name: "Entertainment", desc: "Streaming, content platforms" },
];

const whyChoose = [
  { icon: Users, title: "Senior Web Engineers", description: "Full-stack experts with 5+ years average experience in React, Next.js, Node.js, and cloud platforms." },
  { icon: Clock, title: "Rapid Time-to-Market", description: "Agile sprints with 2-week cycles — from concept to production in as little as 6 weeks." },
  { icon: ShieldCheck, title: "Security & Performance", description: "OWASP-compliant, Core Web Vitals optimized, with SSL, CSP, and enterprise-grade security." },
  { icon: HeartHandshake, title: "Post-Launch Partnership", description: "Ongoing maintenance, monitoring, analytics, SEO optimization, and feature evolution." },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
                Web<br /><span className="text-[#006ea3]">Development</span>
              </h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
                We build responsive, secure, and blazing-fast web applications — from startup landing pages to complex enterprise platforms. Every project is built with performance, accessibility, and SEO in mind.
              </p>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Title bar */}
        <rect x="60" y="50" width="280" height="36" rx="16" className="fill-[#f1f5f9] dark:fill-[#222]" />
        <rect x="60" y="70" width="280" height="16" className="fill-[#f1f5f9] dark:fill-[#222]" />
        <circle cx="82" cy="68" r="5" className="fill-[#ff5f57]" />
        <circle cx="98" cy="68" r="5" className="fill-[#febc2e]" />
        <circle cx="114" cy="68" r="5" className="fill-[#28c840]" />
        <rect x="150" y="63" width="120" height="10" rx="5" className="fill-black/[0.06] dark:fill-white/[0.06]" />
        {/* Navbar */}
        <rect x="72" y="96" width="256" height="30" rx="6" className="fill-[#006ea3]/5 dark:fill-[#006ea3]/10" />
        <rect x="84" y="106" width="40" height="6" rx="3" className="fill-[#006ea3]" />
        <rect x="134" y="106" width="30" height="6" rx="3" className="fill-black/20 dark:fill-white/20" />
        <rect x="174" y="106" width="35" height="6" rx="3" className="fill-black/20 dark:fill-white/20" />
        <rect x="280" y="103" width="36" height="12" rx="6" className="fill-[#006ea3]" />
        <rect x="287" y="107" width="22" height="4" rx="2" className="fill-white" />
        {/* Hero section */}
        <rect x="72" y="140" width="140" height="12" rx="4" className="fill-black/70 dark:fill-white/70" />
        <rect x="72" y="158" width="100" height="8" rx="3" className="fill-[#006ea3]" />
        <rect x="72" y="174" width="160" height="5" rx="2.5" className="fill-black/20 dark:fill-white/20" />
        <rect x="72" y="184" width="140" height="5" rx="2.5" className="fill-black/15 dark:fill-white/15" />
        <rect x="72" y="200" width="60" height="20" rx="6" className="fill-[#006ea3]" />
        <rect x="79" y="207" width="46" height="6" rx="3" className="fill-white" />
        {/* Cards grid */}
        <rect x="72" y="232" width="118" height="80" rx="10" className="fill-black/[0.03] dark:fill-white/[0.04] stroke-black/[0.06] dark:stroke-white/[0.06]" strokeWidth="1" />
        <rect x="84" y="246" width="40" height="6" rx="3" className="fill-[#006ea3]/40" />
        <rect x="84" y="258" width="80" height="10" rx="3" className="fill-[#006ea3] dark:fill-[#3ba0d6]" />
        <rect x="84" y="276" width="60" height="4" rx="2" className="fill-black/15 dark:fill-white/15" />
        <polyline points="140,296 150,282 160,288 170,274 180,278" className="stroke-[#006ea3] dark:stroke-[#3ba0d6]" strokeWidth="2" fill="none" strokeLinecap="round" />
        <rect x="200" y="232" width="118" height="80" rx="10" className="fill-black/[0.03] dark:fill-white/[0.04] stroke-black/[0.06] dark:stroke-white/[0.06]" strokeWidth="1" />
        <rect x="212" y="246" width="50" height="6" rx="3" className="fill-emerald-500/40" />
        <rect x="212" y="258" width="70" height="10" rx="3" className="fill-emerald-500" />
        <rect x="212" y="276" width="55" height="4" rx="2" className="fill-black/15 dark:fill-white/15" />
        <rect x="72" y="322" width="246" height="40" rx="10" className="fill-black/[0.02] dark:fill-white/[0.03] stroke-black/[0.04] dark:stroke-white/[0.04]" strokeWidth="1" />
        <circle cx="94" cy="342" r="10" className="fill-[#006ea3]/10" />
        <rect x="112" y="336" width="80" height="5" rx="2.5" className="fill-black/40 dark:fill-white/40" />
        <rect x="112" y="346" width="120" height="4" rx="2" className="fill-black/15 dark:fill-white/15" />
        <rect x="270" y="336" width="36" height="12" rx="6" className="fill-[#006ea3]/15" />
      </motion.svg>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] font-bold text-black/70 dark:text-white/70">React + Next.js</p>
            <p className="text-[9px] text-black/40 dark:text-white/40">Full-stack</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] font-bold text-black/70 dark:text-white/70">99+ Lighthouse</p>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] font-bold text-black/70 dark:text-white/70">TypeScript</p>
            <p className="text-[9px] text-black/40 dark:text-white/40">Type-safe</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] font-bold text-black/70 dark:text-white/70">OWASP</p>
            <p className="text-[9px] text-black/40 dark:text-white/40">Secure</p>
          </div>
        </div>
      </motion.div>
      <motion.div
...
const serviceCardLogos: { logos: string[]; accent: string }[] = [
  { logos: ["react/react-original.svg", "typescript/typescript-original.svg", "nodejs/nodejs-original.svg"], accent: "#61DAFB" },
  { logos: ["wordpress/wordpress-original.svg", "php/php-original.svg", "mysql/mysql-original.svg"], accent: "#21759B" },
  { logos: ["html5/html5-original.svg", "css3/css3-original.svg", "tailwindcss/tailwindcss-original.svg"], accent: "#E34F26" },
  { logos: ["nodejs/nodejs-original.svg", "mongodb/mongodb-original.svg", "react/react-original.svg"], accent: "#3DDC84" },
  { logos: ["react/react-original.svg", "nextjs/nextjs-original.svg", "typescript/typescript-original.svg"], accent: "#000000" },
  { logos: ["html5/html5-original.svg", "javascript/javascript-original.svg", "css3/css3-original.svg"], accent: "#5A0FC8" },
];
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Ready to Build Your<br /><span className="text-[#006ea3]">Web Platform?</span></h2>
        <p className={`mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-xl mx-auto leading-relaxed transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Let&apos;s create a web experience your users will love. Book a free strategy session with our web experts.</p>
