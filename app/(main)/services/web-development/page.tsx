...
const services: ServiceOffering[] = [
  {
    ...
    description: "Purpose-built, high-performance web properties engineered around your precise operational needs, complete with third-party integrations and bespoke capabilities.",
    features: ["Purpose-built builds", "Third-party APIs", "Architecture that scales"],
    href: "/services/web-development/custom-website-development",
  },
  {
    icon: FileCode2,
    title: "CMS Website Development",
    description: "Content management implementations on WordPress, Strapi, or headless CMS stacks so teams can publish, revise, and govern content with minimal friction.",
    features: ["WordPress & Strapi", "Headless CMS options", "Streamlined editorial workflows"],
    href: "/services/web-development/cms-website-development",
  },
  {
    icon: Smartphone,
    title: "Responsive Website Design",
    description: "Meticulously responsive experiences that render flawlessly from the largest desktop canvases down to tablets and phones.",
    features: ["Mobile-first execution", "Cross-browser fidelity", "Layouts that adapt fluidly"],
    href: "/services/web-development/responsive-website-design",
  },
  {
    icon: ShoppingCart,
    title: "E-Commerce Website Development",
    description: "Growth-ready storefronts featuring trusted payment rails, disciplined inventory workflows, and shopping journeys tuned for conversion.",
    features: ["Payments & gateways", "Rich product catalogs", "Multi-currency readiness"],
    href: "/services/web-development/ecommerce-website-development",
  },
  {
    icon: Zap,
    title: "Single Page App Development",
    description: "High-velocity SPAs with fluid routing, minimal perceived latency, and living interfaces crafted for today’s user expectations.",
    features: ["React & Next.js", "Near-instant transitions", "Live, data-aware UI"],
    href: "/services/web-development/single-page-app-development",
  },
  {
    icon: Globe,
    title: "Progressive Web App Development",
    description: "Add-to-home-screen experiences with offline resilience, push messaging, and native-grade interaction—without navigating an app marketplace.",
    features: ["Offline resilience", "Push messaging", "Install-from-browser"],
    href: "/services/web-development/progressive-web-app-development",
  },
];

const processSteps = [
  { step: "01", title: "Strategy & Research", description: "Landscape scans, competitive intelligence, crystallized business objectives, and a sequenced feature roadmap.", icon: BarChart3 },
...
const industries = [
  { icon: Stethoscope, name: "Healthcare", desc: "Patient portals and virtual-care experiences" },
  { icon: ShoppingCart, name: "E-Commerce", desc: "Digital storefronts and multi-vendor marketplaces" },
  { icon: CreditCard, name: "FinTech", desc: "Executive dashboards and payment infrastructure" },
  { icon: GraduationCap, name: "Education", desc: "Learning management and online course ecosystems" },
  { icon: Truck, name: "Logistics", desc: "Shipment visibility and fleet operations tooling" },
  { icon: Building2, name: "Real Estate", desc: "Listing engines and brokerage portals" },
  { icon: Factory, name: "Manufacturing", desc: "ERP touchpoints and inventory control surfaces" },
  { icon: Gamepad2, name: "Entertainment", desc: "Streaming stacks and audience-facing content hubs" },
];

const whyChoose = [
  { icon: Users, title: "Seasoned Engineering Bench", description: "Full-stack practitioners averaging five or more years across React, Next.js, Node.js, and major cloud ecosystems." },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
                Web<br /><span className="text-[#4EB3E8]">Development</span>
              </h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
                We engineer responsive, secure, and exceptionally fast web experiences—from refined startup landing pages to sophisticated enterprise platforms—each shaped with performance, accessibility, and SEO excellence top of mind.
              </p>
  ...
  return (
    ...
    >
      <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl shadow-black/10 dark:shadow-black/40 border border-black/[0.06] dark:border-white/[0.06]">
        <Image src="https://images.unsplash.com/photo-1547658719-da2b51169166?w=800&h=600&fit=crop&q=80" alt="Web development" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" priority unoptimized />
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#4EB3E8]/10"><Globe className="w-4 h-4 text-[#4EB3E8]" /></div>
          <div><div className="text-sm font-bold text-black dark:text-white">React + Next.js</div><div className="text-[10px] font-medium text-black/40 dark:text-white/40">Full-stack delivery</div></div>
        </div>
      </motion.div>
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
        <div className="flex items-center gap-3">
          ...
          <div><div className="text-sm font-bold text-black dark:text-white">99+ Score</div><div className="text-[10px] font-medium text-black/40 dark:text-white/40">Lighthouse performance</div></div>
        </div>
      </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">End-to-end web capabilities shaped around your objectives, constraints, and trajectory.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-24">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <span className="inline-block text-[11px] font-semibold text-[#4EB3E8] uppercase tracking-[0.2em] mb-4">Delivery Model</span>
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">A proven, transparent playbook engineered for quality gates, stakeholder visibility, and dependable ship dates.</p>
        </motion.div>
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <span className="inline-block text-[11px] font-semibold text-[#4EB3E8] uppercase tracking-[0.2em] mb-4">Technology Stack</span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Engineered with <span className="text-black dark:text-white">Leading Tooling</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Best-in-class frameworks and platforms underpinning every line of production code we ship.</p>
        </motion.div>
        ...
        <motion.div className="mt-16 pt-12 border-t border-black/[0.06] dark:border-white/[0.06]" initial={{ opacity: 0, y: 20 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: 0.5 }}>
          <p className="text-center text-sm font-semibold text-black/30 dark:text-white/25 uppercase tracking-[0.2em] mb-8">Plus the wider ecosystem we integrate day to day</p>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">Vertical fluency across regulated and high-velocity markets—each build reflects the nuance of your field.</p>
        </motion.div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Ready to Launch Your<br /><span className="text-[#4EB3E8]">Web Platform?</span></h2>
        <p className={`mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-xl mx-auto leading-relaxed transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Let&apos;s craft a web experience your audience will return to—reserve a complimentary strategy session with our specialists.</p>
