...
const processSteps = [
  {
    step: "01",
    title: "Strategy",
    description: "Positioning, catalog structure, fulfillment model, and KPIs that shape the storefront and integrations.",
    icon: ClipboardList,
  },
  {
    step: "02",
    title: "Design",
    description: "Conversion-focused UX, component libraries, and brand systems that hold up across devices.",
    icon: Palette,
  },
  {
    step: "03",
    title: "Development",
    description: "Store build, ERP/CRM integrations, and feature flags so you can stage risky changes safely.",
    icon: Code2,
  },
  {
    step: "04",
    title: "Payment Setup",
    description: "Processor configuration, tax/shipping rules, fraud tooling, and reconciliation dashboards.",
    icon: CreditCard,
  },
  {
    step: "05",
    title: "Testing",
    description: "Order flows, edge cases, load tests, and payment sandbox drills before traffic arrives.",
    icon: ShieldCheck,
  },
  {
    step: "06",
    title: "Launch",
    description: "DNS, monitoring, analytics validation, and hypercare through the first revenue week.",
    icon: Rocket,
  },
];

const techCategories = [
  { label: "Platforms", items: ["Shopify", "WooCommerce", "Magento", "BigCommerce"] },
  { label: "Frontend", items: ["React", "Next.js", "Liquid", "PHP"] },
  { label: "Backend", items: ["Node.js", "PHP", "Python", "GraphQL"] },
  { label: "Payments", items: ["Stripe", "PayPal", "Razorpay", "Square"] },
  { label: "Tools", items: ["Google Analytics", "Hotjar", "Klaviyo", "Mailchimp"] },
];
...
const whyChoose = [
  {
    ...
    description: "We optimize funnels, page speed, and trust signals — not just ship templates.",
  },
  {
    icon: ShieldCheck,
    title: "Secure Payments",
    description: "PCI-minded integrations, least-privilege keys, and observability around money-moving paths.",
  },
  {
    icon: Package,
    title: "Scalable Architecture",
    description: "Catalog, inventory, and checkout designed for growth spikes and international expansion.",
  },
  {
    icon: HeartHandshake,
    title: "Growth Support",
    description: "Experimentation, merchandising support, and roadmap delivery after go-live.",
  },
];
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">E-Commerce Website Development Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Storefronts and marketplaces with payments, inventory, and analytics wired for growth — not just a theme swap.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our E-Commerce Website Development Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            From strategy to launch — structured delivery with payments, inventory, and QA treated as first-class concerns.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Commerce platforms, frontends, APIs, payments, and growth tooling for reliable online retail.
        </p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for E-Commerce Website Development</h2>
      </div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#006ea3]">Online Store?</span>
        </h2>
        <p
