...
const techCategories = [
  { label: "Frameworks", items: ["React", "Vue.js", "Angular", "Svelte"] },
  { label: "State", items: ["Redux", "Zustand", "Pinia", "MobX", "NgRx"] },
  { label: "Build", items: ["Vite", "Webpack", "esbuild", "SWC"] },
  { label: "Backend", items: ["REST APIs", "GraphQL", "WebSockets", "Node.js"] },
  { label: "Testing", items: ["Jest", "Cypress", "Playwright", "Vitest"] },
];
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Single Page App Development Services</h2>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Single Page App Development Process</h2>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Single Page App Development</h2>
      </div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          Ready to Build Your
          <br />
          <span className="text-[#006ea3]">SPA?</span>
        </h2>
        <p
        ...
        >
          Partner with us for fast client-side navigation, disciplined architecture, and measurable performance in production.
        </p>
        <div
