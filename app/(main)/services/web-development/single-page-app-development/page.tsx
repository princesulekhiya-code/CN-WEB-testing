        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Lightning-fast SPAs with seamless navigation, instant transitions, and dynamic content loading.
              </p>
              <div
...
function HeroVisual({ heroReady }: { heroReady: boolean }) {
  ...
  const c1 = useAnimatedCount(stats[1].value, visible, 120);
  const c2 = useAnimatedCount(stats[2].value, visible, 240);
  const c3 = useAnimatedCount(stats[3].value, visible, 360);
  const counts = [c0, c1, c2, c3];

  const items = [
    { icon: Zap, label: "Speed" },
    { icon: Layers, label: "Components" },
    { icon: Code2, label: "React/Vue" },
    { icon: Globe, label: "SPA" },
  ];
    ...
    <div ref={ref} className="space-y-6">
              ...
              >
                <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl shadow-black/10 dark:shadow-black/40 border border-black/[0.06] dark:border-white/[0.06]">
                  <Image
                    ...
                    alt="Modern single page application code in editor"
                    fill
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">SPA Expert</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">React & Vue</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Instant Nav</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Client-side routing</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
      ...
      >
        {stats.map((stat, i) => (
          <div
            key={stat.label}
            className="text-center rounded-xl border border-[#4EB3E8]/10 bg-[#4EB3E8]/[0.04] dark:bg-[#4EB3E8]/[0.06] px-2 py-3"
          >
            <div className="text-lg md:text-xl font-bold text-[#4EB3E8] tabular-nums">
              {counts[i]}
              {stat.suffix}
            </div>
            <div className="mt-0.5 text-[10px] md:text-xs font-medium text-black/40 dark:text-white/40 leading-tight">
              {stat.label}
            </div>
          </div>
        ))}
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Single Page App <span className="text-black dark:text-white">Development Services</span>
          </h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
            Framework-native SPAs with crisp routing, disciplined state, and performance budgets baked into delivery.
          </p>
        </motion.div>
...
function ProcessSection() {
  ...
  return (
    <div
      ref={ref}
      className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]"
    >
      ...
      <div className="absolute top-1/3 left-0 w-[400px] h-[400px] bg-[#4EB3E8]/[0.04] rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-0 w-[300px] h-[300px] bg-[#4EB3E8]/[0.04] rounded-full blur-[100px] pointer-events-none" />
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Our Single Page App <span className="text-black dark:text-white">Development Process</span>
          </h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            From planning to deployment — architecture, APIs, and testing treated as one continuous system.
          </p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
            Frameworks, state management, build tooling, APIs, and test stacks for production-grade SPAs.
          </p>
        </motion.div>
        ...
        >
          <p className="text-center text-xs font-semibold uppercase tracking-widest text-black/30 dark:text-white/30 mb-6">
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">
            Why Choose <span className="text-black dark:text-white">Cloud Nexus</span> for SPA Development
          </h2>
        </motion.div>
...
function CTASection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden border-t border-black/[0.06] dark:border-white/[0.06]">
      <div className="absolute inset-0 bg-gradient-to-br from-[#4EB3E8]/10 via-[#4EB3E8]/5 to-indigo-500/5 dark:from-[#4EB3E8]/8 dark:via-[#4EB3E8]/4 dark:to-indigo-500/5 pointer-events-none" />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[500px] bg-[#4EB3E8]/8 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#4EB3E8]/5 rounded-full blur-[100px] pointer-events-none" />
      <div
        className="absolute inset-0 pointer-events-none opacity-[0.03] dark:opacity-[0.04]"
        style={{
          backgroundImage:
            "linear-gradient(rgba(78,179,232,0.25) 1px, transparent 1px), linear-gradient(90deg, rgba(78,179,232,0.25) 1px, transparent 1px)",
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 text-center">
        <motion.h2
          ...
          transition={{ duration: 0.6 }}
        >
          <span className="text-[#999] dark:text-[#8b8b8b]">Ready to Build Your</span>
          <br />
          <span className="text-[#4EB3E8]">Next SPA?</span>
        </motion.h2>
        <motion.p
          className="mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed"
          initial={{ opacity: 0, y: 16 }}
          animate={visible ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.5, delay: 0.12 }}
        >
          Partner with us for fast client-side navigation, disciplined architecture, and measurable performance in
          production.
        </motion.p>
        <motion.div
        ...
        >
          <Link
            href="/resources/free-consultation"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-[#4EB3E8] text-white font-semibold text-sm hover:bg-[#3aa3d6] dark:hover:bg-[#3aa3d6] transition-colors shadow-lg shadow-[#4EB3E8]/30 ring-1 ring-white/20"
          >
            Get a Free Consultation <ArrowRight className="w-4 h-4" />
          </Link>
          <Link
            href="/our-work"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl border border-black/10 dark:border-white/10 font-semibold text-sm bg-white/50 dark:bg-white/[0.04] hover:bg-[#4EB3E8]/[0.08] dark:hover:bg-[#4EB3E8]/[0.1] transition-colors"
          >
            View Our Work
          </Link>
        </motion.div>
