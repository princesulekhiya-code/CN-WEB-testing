...
const techCategories = [
  { label: "IaC Tools", items: ["Terraform", "Pulumi", "CDK", "CloudFormation", "Bicep"] },
  { label: "Config Management", items: ["Ansible", "Chef", "Puppet", "Salt"] },
  { label: "Testing", items: ["Terratest", "Checkov", "tfsec", "OPA", "Sentinel"] },
  { label: "State & Registry", items: ["Terraform Cloud", "S3/DynamoDB", "Spacelift", "env0"] },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Infrastructure<br /><span className="text-[#006ea3]">as Code</span></h1>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Six focused capabilities covering modules, provisioning, configuration, state, multi-cloud strategy, and validation.</p>
      </div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Ready to Codify Your<br /><span className="text-[#006ea3]">Infrastructure?</span></h2>
