...
const services: ServiceOffering[] = [
  { icon: Store, title: "Custom Store Development", description: "Tailored storefronts with modular features, performance budgets, and integrations aligned to your catalog and fulfillment model.", features: ["Custom themes", "Module extensions", "Performance tuning"] },
...
const processSteps = [
  { step: "01", title: "Requirements Analysis", description: "Stakeholder workshops, journey mapping, and success metrics to lock scope and integrations.", icon: ClipboardList },
...
const techCategories = [
  { label: "Platforms", items: ["Shopify", "Magento", "WooCommerce", "BigCommerce", "OpenCart"] },
  { label: "Frontend", items: ["React", "Next.js", "Vue.js", "Tailwind CSS", "TypeScript"] },
  { label: "Backend", items: ["Node.js", "PHP", "Python", "Laravel", "Ruby on Rails"] },
  { label: "Database", items: ["PostgreSQL", "MySQL", "MongoDB", "Redis", "Elasticsearch"] },
  { label: "Cloud", items: ["AWS", "Azure", "GCP", "Cloudflare", "Vercel"] },
];
...
const heroCards = [
  { icon: Store, label: "B2B & B2C" },
  { icon: Gauge, label: "Scalable" },
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>eCommerce<br /><span className="text-[#006ea3]">Online Platform</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Advanced, scalable B2B and B2C eCommerce online stores leveraging the latest tech stack and custom functionalities.</p>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">eCommerce Online Platform Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">End-to-end capabilities to launch and grow B2B and B2C stores with custom workflows and integrations.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">From discovery to launch — a structured path for your eCommerce online platform.</p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Platforms, frontends, backends, data stores, and cloud foundations we use to ship resilient stores.</p>
      </div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Ready to Build Your<br /><span className="text-[#006ea3]">Online Store?</span></h2>
        <p className={`mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-xl mx-auto leading-relaxed transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Partner with us to launch a scalable B2B or B2C eCommerce platform tailored to your business.</p>
