...
const services: ServiceOffering[] = [
  { icon: Building2, title: "Enterprise Portal Development", description: "Role-based portals, approvals, and self-service workflows aligned to complex org structures.", features: ["RBAC", "Approvals", "Self-service"] },
...
const processSteps = [
  { step: "01", title: "Enterprise Assessment", description: "Stakeholder interviews, integration inventory, and risk register for the commerce program.", icon: ClipboardList },
...
const techCategories = [
  { label: "Platforms", items: ["Magento Enterprise", "Shopify Plus", "SAP Commerce", "Oracle Commerce", "Salesforce Commerce"] },
  { label: "ERP", items: ["SAP", "Oracle", "Microsoft Dynamics", "NetSuite", "Odoo"] },
  { label: "Frontend", items: ["React", "Next.js", "Angular", "Vue.js", "TypeScript"] },
  { label: "Security", items: ["SOC 2", "PCI DSS", "GDPR", "ISO 27001", "HIPAA"] },
  { label: "Infrastructure", items: ["AWS", "Azure", "GCP", "Kubernetes", "Terraform"] },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Enterprise<br /><span className="text-[#006ea3]">eCommerce</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>SEO-friendly custom enterprise portals supporting effortless business management with seamless user experience.</p>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Enterprise eCommerce Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Portals, ERP, analytics, and governance for large-scale digital commerce programs.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">Assessment through training — enterprise-grade delivery for mission-critical commerce.</p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Enterprise platforms, ERP systems, secure frontends, and cloud-native infrastructure.</p>
      </div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Scale With<br /><span className="text-[#006ea3]">Enterprise eCommerce</span></h2>
        <p className={`mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-xl mx-auto leading-relaxed transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Deploy SEO-friendly portals, ERP-connected operations, and secure experiences your teams can run with confidence.</p>
