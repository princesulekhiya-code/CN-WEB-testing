...
const services: ServiceOffering[] = [
  { icon: Plug, title: "Payment Gateway Integration", description: "Processor-agnostic integrations with webhooks, idempotency, and reconciliation aligned to your ledger.", features: ["Webhooks", "Retries", "Reconciliation"] },
...
const processSteps = [
  { step: "01", title: "Payment Audit", description: "Current flows, decline reasons, and compliance gaps reviewed with stakeholders.", icon: ClipboardList },
...
const techCategories = [
  { label: "Gateways", items: ["Stripe", "PayPal", "Braintree", "Adyen", "Square"] },
  { label: "Wallets", items: ["Apple Pay", "Google Pay", "Amazon Pay", "Shop Pay", "Samsung Pay"] },
  { label: "Security", items: ["PCI DSS", "3D Secure", "Tokenization", "SSL", "Fraud Detection"] },
  { label: "Backend", items: ["Node.js", "Python", "Java", ".NET", "Go"] },
  { label: "Billing", items: ["Stripe Billing", "Chargebee", "Recurly", "Paddle", "Zuora"] },
];
...
const heroCards = [
  { icon: CreditCard, label: "Gateways" },
  { icon: FileStack, label: "One-page" },
  { icon: ShieldAlert, label: "Fraud" },
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Payment &<br /><span className="text-[#006ea3]">Checkout</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Stripe, PayPal, and regional gateways with fraud signals and mobile-optimized one-page checkout flows.</p>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Payment & Checkout Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Gateways, wallets, subscriptions, and risk controls engineered for conversion and compliance.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">From audit to live monitoring — a disciplined rollout for payments and checkout.</p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Processors, wallets, security controls, service backends, and billing platforms for modern commerce.</p>
      </div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Optimize Your<br /><span className="text-[#006ea3]">Checkout</span></h2>
        <p className={`mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-xl mx-auto leading-relaxed transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Integrate trusted gateways, reduce fraud, and convert more with a fast, mobile-first payment experience.</p>
