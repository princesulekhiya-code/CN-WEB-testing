...
const services: ServiceOffering[] = [
  { icon: Users, title: "Vendor Management Portal", description: "Onboarding, contracts, and performance dashboards so operators can govern seller quality at scale.", features: ["Seller KYC", "Policies", "Performance"] },
...
const processSteps = [
  { step: "01", title: "Marketplace Strategy", description: "Business model, fee structure, and policies aligned to your category and region.", icon: Compass },
...
const techCategories = [
  { label: "Platforms", items: ["Magento", "Shopify Plus", "WooCommerce", "Custom", "Medusa"] },
  { label: "Payments", items: ["Stripe Connect", "PayPal", "Razorpay", "Escrow", "Split Payments"] },
  { label: "Search", items: ["Elasticsearch", "Algolia", "MeiliSearch", "Typesense", "Solr"] },
  { label: "Infrastructure", items: ["AWS", "Docker", "Kubernetes", "Redis", "CDN"] },
  { label: "Analytics", items: ["Mixpanel", "GA4", "Segment", "Metabase", "Looker"] },
];
...
const heroCards = [
  ...
  { icon: LayoutGrid, label: "Listings" },
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Multi-Vendor<br /><span className="text-[#006ea3]">Marketplace</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Reliable multi-vendor marketplaces with streamlined experiences for buyers and sellers with multiple payment gateways.</p>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Multi-Vendor Marketplace Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Operator tools, seller experiences, and payments engineered for trust and scale.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">Strategy through scale — how we launch dependable multi-vendor marketplaces.</p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Commerce cores, marketplace payments, search, infra, and analytics wired for operators and sellers.</p>
      </div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Scale Your<br /><span className="text-[#006ea3]">Marketplace</span></h2>
        <p className={`mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-xl mx-auto leading-relaxed transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Launch a multi-vendor platform buyers and sellers trust — with payouts, search, and analytics built in.</p>
