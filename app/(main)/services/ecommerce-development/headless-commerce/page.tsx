...
const services: ServiceOffering[] = [
  { icon: Store, title: "Headless Storefront", description: "Fast, composable storefronts that consume commerce APIs and render on your framework of choice.", features: ["SSR/SSG", "Edge-ready", "Design systems"] },
...
const processSteps = [
  { step: "01", title: "Architecture Design", description: "Domain boundaries, API contracts, and hosting topology for decoupled commerce.", icon: Compass },
...
const techCategories = [
  { label: "Headless CMS", items: ["Contentful", "Strapi", "Sanity", "Prismic", "Hygraph"] },
  { label: "Commerce API", items: ["Medusa", "Saleor", "commercetools", "Shopify Storefront", "BigCommerce"] },
  { label: "Frontend", items: ["Next.js", "Remix", "Nuxt", "Astro", "SvelteKit"] },
  { label: "API", items: ["GraphQL", "REST", "tRPC", "gRPC", "OpenAPI"] },
  { label: "Infrastructure", items: ["Vercel", "Netlify", "AWS", "Cloudflare Workers", "Edge Functions"] },
];
...
const heroCards = [
  { icon: Boxes, label: "API-first" },
  { icon: Puzzle, label: "Composable" },
    ...
    <section className="min-h-screen bg-white text-black dark:bg-black dark:text-white">
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          <Link href="/services/ecommerce-development" className={`inline-flex items-center gap-2 text-sm font-medium text-black/50 hover:text-black dark:text-white/50 dark:hover:text-white transition-all duration-500 mb-8 ${heroReady ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-4"}`}><ArrowLeft size={16} /> Back to eCommerce Development</Link>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Headless<br /><span className="text-[#006ea3]">Commerce</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Decoupled front and back-end architecture for ultimate flexibility — plug any backend to any frontend without impact.</p>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Headless Commerce Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Composable storefronts, APIs, and content orchestration for flexible, future-proof digital commerce.</p>
      </div>
    ...
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">From architecture to launch — a structured path for headless and composable commerce.</p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">Headless CMS, commerce APIs, modern frontends, and edge-ready infrastructure.</p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for eCommerce</h2>
      </div>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Go Headless With<br /><span className="text-[#006ea3]">Composable Commerce</span></h2>
        <p className={`mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-xl mx-auto leading-relaxed transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Decouple your stack and ship faster with APIs, CMS, and storefronts built for change.</p>
