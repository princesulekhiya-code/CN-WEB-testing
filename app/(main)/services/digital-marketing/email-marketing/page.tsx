...
const techCategories = [
  { label: "Platforms", items: ["Mailchimp", "HubSpot", "SendGrid", "Klaviyo", "ActiveCampaign"] },
  { label: "Automation", items: ["Zapier", "Make", "Customer.io", "Drip"] },
  { label: "Design", items: ["Stripo", "BEE Pro", "Litmus", "Email on Acid"] },
  { label: "Analytics", items: ["Google Analytics", "Litmus Analytics", "Mailchimp Reports"] },
];
      ...
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className={`text-center mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            A structured path from insight to inbox — with quality gates at every step.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Platforms, automation, design QA, and analytics we use to ship reliable email programs.
        </p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      <div className={`text-center mb-14 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Email Marketing</h2>
      </div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#006ea3]">Email Strategy?</span>
        </h2>
        <p
