...
const techCategories = [
  {
    label: "Management",
    items: ["Hootsuite", "Buffer", "Sprout Social", "Later"],
  },
  {
    label: "Design",
    items: ["Canva", "Adobe Creative Suite", "Figma", "CapCut"],
  },
  {
    label: "Analytics",
    items: ["Sprout Social", "Socialbakers", "Brandwatch", "Native Analytics"],
  },
  {
    label: "Advertising",
    items: [
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Social Media
                <br />
                <span className="text-[#006ea3]">Marketing</span>
              </h1>
              <p
    ...
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          End-to-end programs covering strategy, creative, community, creators,
          paid social, and analytics—built for brands that want durable growth.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          ...
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            A six-step timeline from discovery through optimization—transparent,
            iterative, and aligned to business outcomes.
          </p>
        </div>
              ...
              >
                ...
                <div className="md:hidden flex items-start gap-5 w-full">
                  ...
                  <div className="flex-1 pt-0.5">
                    ...
                    <h3 className="text-base font-semibold mt-1 tracking-tight">
                      {step.title}
                    </h3>
                    <p className="mt-2 text-sm font-medium text-black/45 dark:text-white/45 leading-relaxed">
                      {step.description}
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          The publishing, design, analytics, and ads stack we use to keep
          programs organized, on-brand, and measurable.
        </p>
      </div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {techCategories.map((cat, ci) => (
          ...
          >
            <h3 className="text-sm font-semibold text-[#006ea3] uppercase tracking-wider mb-4">
              {cat.label}
            </h3>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
          Why Choose Cloud Nexus for Social Media
        </h2>
      </div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          Ready to Dominate
          <br />
          <span className="text-[#006ea3]">Social Media?</span>
        </h2>
        <p
