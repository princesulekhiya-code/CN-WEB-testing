...
const processSteps = [
  {
    ...
    title: "Brand Audit",
    description:
      "Channel health check, competitor snapshots, audience signals, and quick wins versus structural gaps.",
    icon: Search,
  },
  {
    step: "02",
  ...
  },
  {
    ...
    description:
      "Rhythm of posts, hooks, formats, and approvals mapped to launches, seasons, and cultural moments.",
    icon: Calendar,
  },
  {
    step: "04",
    ...
    description:
      "Publishing, paid boosts, UTM hygiene, and creative iterations executed with quality gates.",
    icon: Rocket,
  },
  {
    step: "05",
...
const whyChoose = [
  {
    ...
    description:
      "Hands-on experience across major networks with up-to-date formats, policies, and ad surfaces.",
  },
  {
    icon: Palette,
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Grow awareness, engagement, and conversions with channel-native
                creative, disciplined community care, and paid social that compounds.
              </p>
              <div
            ...
            <div className="space-y-8">
              ...
              >
                <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl shadow-black/10 dark:shadow-black/40 border border-black/[0.06] dark:border-white/[0.06]">
                  <Image
                    src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=800&h=600&fit=crop&q=80"
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">5x Engagement</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Social growth</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">Multi-Platform</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">All channels</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Social Media Marketing <span className="text-black dark:text-white">Offerings</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">End-to-end programs covering strategy, creative, community, creators,
          paid social, and analytics—built for brands that want durable growth.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Our Social Media <span className="text-black dark:text-white">Process</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">A six-step timeline from discovery through optimization—transparent,
            iterative, and aligned to business outcomes.</p>
        </motion.div>
        <div className="relative">
...
function TechStackSection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#999] dark:text-[#8b8b8b]">Tools & <span className="text-black dark:text-white">Platforms</span></h2>
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">The publishing, design, analytics, and ads stack we use to keep
          programs organized, on-brand, and measurable.</p>
        </motion.div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center">
        ...
        >
          Ready to Dominate
          <br />
          <span className="text-[#4EB3E8]">Social Media?</span>
        </h2>
        <p
        ...
        >
          Partner with us for channel-native strategy, standout creative, and
          community programs that compound—not just campaign spikes.
        </p>
        <div
