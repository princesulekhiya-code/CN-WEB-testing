...
import {
  ArrowRight, ArrowLeft, Search, Target, Share2, Mail, TrendingUp, BarChart3, Zap,
  Layers, Palette, Settings, Rocket, CheckCircle2, Users, Clock,
  HeartHandshake, ShoppingCart, CreditCard, Stethoscope, GraduationCap,
...
const services: ServiceOffering[] = [
  {
    ...
    description: "Elevate your organic presence with in-depth technical audits, precision keyword mapping, content-level optimization, and high-authority link acquisition.",
  ...
  },
  {
    ...
    description: "High-performance Google, Meta, and LinkedIn campaigns — surgically targeted audiences, algorithmic bid tuning, and relentless A/B testing to squeeze every dollar.",
    features: ["Google & Meta Ads", "Bid optimization", "A/B testing"],
    href: "/services/digital-marketing/ppc-advertising",
  },
  {
    icon: Share2,
    title: "Social Media Marketing (SMM)",
    description: "Grow brand authority and meaningful engagement through strategic storytelling, proactive community management, and viral-ready growth campaigns.",
    features: ["Content strategy", "Community management", "Growth campaigns"],
    href: "/services/digital-marketing/social-media-marketing",
  },
  {
    icon: Mail,
    title: "Email Marketing",
    description: "Behavior-triggered sequences, polished newsletter campaigns, and hyper-personalized drip flows that nurture leads and deepen customer lifetime value.",
  ...
  },
  {
    ...
    description: "SEO-rich blog posts, thought-leadership whitepapers, and persuasive web copy that draw your ideal audience and build steady organic momentum.",
    features: ["Blog & articles", "Copywriting", "Content calendar"],
    href: "/services/digital-marketing/content-marketing",
  },
  {
    icon: BarChart3,
    title: "App Store Optimization (ASO)",
    description: "Maximize app discoverability and install rates through optimized titles, keyword coverage, compelling screenshots, and proactive review management.",
    features: ["Keyword optimization", "Visual assets", "Review strategy"],
    href: "/services/digital-marketing/app-store-optimization",
  },
];

const processSteps = [
  { step: "01", title: "Audit & Discovery", description: "Analyzing your current digital presence, competitors, SEO health, and market opportunities.", icon: Search },
...
const techCategories: { label: string; items: { name: string; logo: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "TikTok Ads", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
    ],
  },
  {
    label: "Email & CRM",
    items: [
      ...
      { name: "Klaviyo", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
    ],
  },
  {
    label: "Social Media",
    items: [
      { name: "Hootsuite", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
      { name: "Buffer", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
      { name: "Sprout Social", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
      { name: "Later", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Screaming Frog", logo: `${DEVICON}/nodejs/nodejs-original.svg` },
      { name: "Yoast", logo: `${DEVICON}/wordpress/wordpress-original.svg` },
    ],
  },
  {
    ...
    items: [
      { name: "Canva", logo: `${DEVICON}/canva/canva-original.svg` },
      { name: "Adobe Creative Suite", logo: `${DEVICON}/photoshop/photoshop-original.svg` },
      { name: "Figma", logo: `${DEVICON}/figma/figma-original.svg` },
      { name: "WordPress", logo: `${DEVICON}/wordpress/wordpress-original.svg` },
      { name: "Webflow", logo: `${DEVICON}/webflow/webflow-original.svg` },
    ],
  },
]

const industries = [
  { icon: Stethoscope, name: "Healthcare", desc: "Patient acquisition, HIPAA-compliant campaigns" },
  { icon: ShoppingCart, name: "E-Commerce", desc: "Product ads, shopping campaigns" },
  { icon: CreditCard, name: "FinTech", desc: "Lead generation, compliance marketing" },
  { icon: GraduationCap, name: "Education", desc: "Enrollment campaigns, LMS promotion" },
  { icon: Truck, name: "Logistics", desc: "B2B lead gen, brand visibility" },
  { icon: Building2, name: "Real Estate", desc: "Property marketing, local SEO" },
  { icon: Factory, name: "Manufacturing", desc: "Industrial marketing, trade campaigns" },
  { icon: Gamepad2, name: "Entertainment", desc: "App marketing, audience growth" },
];

const whyChoose = [
  { icon: Users, title: "Certified Marketing Experts", description: "Google, Meta, and HubSpot certified specialists with 5+ years average experience in performance marketing." },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
                Digital<br /><span className="text-[#4EB3E8]">Marketing</span>
              </h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
                Fuel sustainable growth with analytics-led digital marketing. From organic search to precision-targeted campaigns, our specialists deliver measurable outcomes that move the revenue needle.
              </p>
  ...
  return (
    <motion.div className="relative w-full max-w-md mx-auto aspect-[4/3]" initial={{ opacity: 0, scale: 0.92, x: 20 }} animate={{ opacity: 1, scale: 1, x: 0 }} transition={{ duration: 0.9, delay: 0.3, ease: [0.16, 1, 0.3, 1] }}>
      <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl shadow-black/10 dark:shadow-black/40 border border-black/[0.06] dark:border-white/[0.06]">
        <Image src="https://images.unsplash.com/photo-1533750349088-cd871a92f312?w=800&h=600&fit=crop&q=80" alt="Digital marketing services" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" priority unoptimized />
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#4EB3E8]/10"><TrendingUp className="w-4 h-4 text-[#4EB3E8]" /></div>
          <div><div className="text-sm font-bold text-black dark:text-white">300% ROI</div><div className="text-[10px] font-medium text-black/40 dark:text-white/40">Average return</div></div>
        </div>
      </motion.div>
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
        <div className="flex items-center gap-3">
          ...
          <div><div className="text-sm font-bold text-black dark:text-white">10M+ Reach</div><div className="text-[10px] font-medium text-black/40 dark:text-white/40">Monthly impressions</div></div>
        </div>
      </motion.div>
...
const serviceCardLogos: { logos: string[]; accent: string }[] = [
  { logos: ["google/google-original.svg", "html5/html5-original.svg", "css3/css3-original.svg"], accent: "#4285F4" },
  { logos: ["google/google-original.svg", "facebook/facebook-original.svg", "linkedin/linkedin-original.svg"], accent: "#34A853" },
  { logos: ["facebook/facebook-original.svg", "twitter/twitter-original.svg", "linkedin/linkedin-original.svg"], accent: "#1DA1F2" },
  { logos: ["nodejs/nodejs-original.svg", "html5/html5-original.svg", "css3/css3-original.svg"], accent: "#F4B400" },
  { logos: ["wordpress/wordpress-original.svg", "html5/html5-original.svg", "figma/figma-original.svg"], accent: "#EA4335" },
  { logos: ["apple/apple-original.svg", "android/android-original.svg", "google/google-original.svg"], accent: "#4EB3E8" },
];
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <span className="inline-block text-[11px] font-semibold text-[#4EB3E8] uppercase tracking-[0.2em] mb-4">Our Services</span>
    ...
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-24">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <span className="inline-block text-[11px] font-semibold text-[#4EB3E8] uppercase tracking-[0.2em] mb-4">How We Work</span>
          ...
          <p className="mt-4 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">A results-driven methodology that ensures quality, transparency, and on-time delivery.</p>
        </motion.div>
...
function IndustriesSection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden border-y border-black/[0.06] dark:border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <span className="inline-block text-[11px] font-semibold text-[#4EB3E8] uppercase tracking-[0.2em] mb-4">Industries</span>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} animate={visible ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <span className="inline-block text-[11px] font-semibold text-[#4EB3E8] uppercase tracking-[0.2em] mb-4">Why Us</span>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Ready to Boost Your<br /><span className="text-[#4EB3E8]">Online Presence?</span></h2>
        <p className={`mt-5 text-base md:text-lg font-medium text-black/50 dark:text-white/50 max-w-xl mx-auto leading-relaxed transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Our team of marketing experts is here to help. We offer a wide range of digital marketing services tailored to meet your specific needs and goals.</p>
