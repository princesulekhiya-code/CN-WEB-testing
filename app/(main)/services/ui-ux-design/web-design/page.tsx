...
const techCategories = [
  ...
  {
    label: "Prototyping",
    items: ["InVision", "Framer", "Marvel", "Principle"],
  },
  {
    label: "Frontend",
  ...
  {
    label: "Testing",
    items: ["Hotjar", "Maze", "UserTesting", "Lookback"],
  },
  {
    label: "Collaboration",
    items: ["Zeplin", "Abstract", "Notion", "Miro"],
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                UI/UX
                <br />
                <span className="text-[#006ea3]">Web Design</span>
              </h1>
              <p
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Web Design Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          From marketing sites to complex web apps — we design interfaces that feel on-brand, load fast, and guide users through every task with confidence.
        </p>
      </div>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Web Design Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            Research through handoff — a transparent sequence that keeps UX, brand, and engineering aligned from the first workshop to launch.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Design, prototype, validate, and hand off with the same toolchain your product and marketing teams already rely on.
        </p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Web Design</h2>
      </div>
    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#006ea3]">Web Experience?</span>
        </h2>
        <p
