...
const techCategories = [
  {
    label: "Design",
    items: ["Figma", "Adobe Illustrator", "Photoshop", "InDesign"],
  },
  {
    label: "Motion",
    items: ["After Effects", "Lottie", "Rive", "Blender"],
  },
  {
    label: "Collaboration",
    items: ["Zeplin", "Notion", "Abstract", "Brand.ai"],
  },
  {
    label: "Prototyping",
    items: ["InVision", "Framer", "Principle"],
  },
  {
    label: "Frontend Integration",
    items: ["Storybook", "Tailwind CSS", "CSS Variables"],
  },
];
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Visual Design Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Identity, illustration, and motion that stay coherent as your channels multiply — from pitch decks to in-app surfaces.
        </p>
      </div>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Visual Design Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            Discovery through delivery — a creative pipeline that protects brand intent while shipping files teams can actually use.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Vector, raster, motion, and integration tools that connect visual design to living products and marketing stacks.
        </p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Visual Design</h2>
      </div>
