...
const services: ServiceOffering[] = [
  { icon: Globe, title: "REST API Development", description: "Versioned HTTP APIs with consistent error models, pagination, and idempotent writes.", features: ["OpenAPI-first", "Versioning", "Rate limits"] },
...
const processSteps = [
  { step: "01", title: "API Requirements", description: "Stakeholder workshops, consumer journeys, and SLAs captured as acceptance criteria.", icon: FileJson },
...
const techCategories = [
  { label: "API", items: ["REST", "GraphQL", "gRPC", "WebSocket", "tRPC"] },
  { label: "Documentation", items: ["Swagger", "Postman", "ReadMe", "Redoc", "Stoplight"] },
  { label: "Auth", items: ["OAuth 2.0", "JWT", "API Keys", "HMAC", "mTLS"] },
  { label: "Testing", items: ["Postman", "Newman", "Pact", "k6", "Artillery"] },
  { label: "Infrastructure", items: ["API Gateway", "Rate Limiting", "Caching", "CDN", "Load Balancing"] },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>SaaS API<br /><span className="text-[#006ea3]">& Integration</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Expert developers integrate varied third-party APIs into your SaaS app by linking external data sources to enhance operations.</p>
