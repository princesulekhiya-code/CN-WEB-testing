...
const services: ServiceOffering[] = [
  { icon: LayoutDashboard, title: "SaaS Dashboard Design", description: "Dense data made legible — navigation, hierarchy, and component patterns tuned for daily power users.", features: ["Information architecture", "Component library", "Responsive layouts"] },
...
const processSteps = [
  { step: "01", title: "User Research", description: "Interviews, analytics review, and jobs-to-be-done mapping to ground decisions in real behavior.", icon: Search },
...
const heroCards = [
  ...
  { icon: BarChart3, label: "Data UX" },
  { icon: Accessibility, label: "Inclusive" },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>SaaS<br /><span className="text-[#4EB3E8]">UI/UX Design</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>User-friendly and interactive enterprise-grade UI/UX designs intending to drive higher revenue and user engagement.</p>
              ...
              >
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="absolute -top-4 -right-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-black dark:text-white">SaaS UX</div>
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">User-first design</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] font-medium text-black/40 dark:text-white/40">Onboarding flow</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
