...
const industries = [
  { icon: Stethoscope, name: "Healthcare", desc: "Patient portals, telemedicine SaaS" },
  { icon: ShoppingCart, name: "Retail", desc: "Inventory, POS, e-commerce SaaS" },
  { icon: CreditCard, name: "Fintech", desc: "Payments, lending, banking SaaS" },
  { icon: Truck, name: "Logistics", desc: "Fleet tracking, supply chain SaaS" },
  { icon: GraduationCap, name: "Education", desc: "LMS, e-learning platforms" },
  { icon: Building2, name: "Real Estate", desc: "Property management SaaS" },
  { icon: Gamepad2, name: "Entertainment", desc: "Streaming, content SaaS" },
  { icon: Factory, name: "Enterprise", desc: "ERP, workflow automation SaaS" },
];
...
const serviceCardLogos: { logos: string[]; accent: string }[] = [
  { logos: ["react/react-original.svg", "nodejs/nodejs-original.svg", "postgresql/postgresql-original.svg"], accent: "#006ea3" },
