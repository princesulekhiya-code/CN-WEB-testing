...
const services: ServiceOffering[] = [
  { icon: BadgeCheck, title: "SOC 2 Compliance", description: "Control mapping, evidence collection, and operating practices aligned to SOC 2 trust criteria.", features: ["Control matrix", "Evidence packs", "Vendor alignment"] },
...
const processSteps = [
  { step: "01", title: "Security Assessment", description: "Threat modeling, asset inventory, and gap analysis against your risk appetite.", icon: Search },
...
const techCategories = [
  { label: "Identity", items: ["Auth0", "Okta", "AWS Cognito", "Firebase Auth", "Keycloak"] },
  { label: "Encryption", items: ["AES-256", "TLS 1.3", "HashiCorp Vault", "AWS KMS", "Let's Encrypt"] },
  { label: "Compliance", items: ["SOC 2", "GDPR", "HIPAA", "ISO 27001", "PCI DSS"] },
  { label: "Monitoring", items: ["Datadog", "Sentry", "Snyk", "SonarQube", "OWASP ZAP"] },
  { label: "Infrastructure", items: ["WAF", "DDoS Protection", "VPN", "Zero Trust", "SIEM"] },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>SaaS Security<br /><span className="text-[#006ea3]">& Compliance</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Best industry practices to maintain SaaS product security and ensure meeting industry compliance standards.</p>
