...
const techCategories = [
  { label: "Backend", items: ["Node.js", "Python", "Go", "Java", ".NET Core"] },
  { label: "Frontend", items: ["React", "Next.js", "Vue.js", "Angular", "TypeScript"] },
  { label: "Database", items: ["PostgreSQL", "MongoDB", "Redis", "DynamoDB", "CockroachDB"] },
  { label: "Cloud", items: ["AWS", "Azure", "GCP", "DigitalOcean", "Heroku"] },
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Custom<br /><span className="text-[#006ea3]">SaaS Platform</span></h1>
