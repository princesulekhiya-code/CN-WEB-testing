...
const services: ServiceOffering[] = [
  { icon: Apple, title: "iOS SaaS App", description: "Native Swift experiences with App Store readiness, subscriptions, and platform conventions.", features: ["SwiftUI/UIKit", "In-app purchases", "Push & background"] },
...
const processSteps = [
  { step: "01", title: "Platform Strategy", description: "Native vs cross-platform, store policies, and roadmap aligned to your SaaS KPIs.", icon: Compass },
...
const techCategories = [
  { label: "iOS", items: ["Swift", "SwiftUI", "Core Data", "StoreKit", "CloudKit"] },
  { label: "Android", items: ["Kotlin", "Jetpack Compose", "Room", "WorkManager", "Material 3"] },
  { label: "Cross-Platform", items: ["Flutter", "React Native", "Ionic", "Capacitor", "Expo"] },
  { label: "Backend", items: ["Firebase", "Supabase", "AWS Amplify", "Node.js", "GraphQL"] },
  { label: "Analytics", items: ["Firebase Analytics", "Mixpanel", "Amplitude", "Sentry", "Crashlytics"] },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>SaaS Mobile<br /><span className="text-[#006ea3]">Solutions</span></h1>
              <p className={`mt-6 text-lg font-medium text-black/50 dark:text-white/50 leading-relaxed max-w-lg transition-all duration-700 delay-200 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>Both native and hybrid SaaS mobile app solutions leveraging smartphone users for maximum reach and engagement.</p>
