...
const techCategories = [
  { label: "Cloud", items: ["AWS", "Azure", "GCP", "Digital Ocean", "Heroku"] },
  { label: "Architecture", items: ["Microservices", "Event-Driven", "CQRS", "Serverless"] },
  { label: "Backend", items: [".NET", "Java Spring", "Node.js", "Python", "Go"] },
  { label: "Database", items: ["PostgreSQL", "MongoDB", "Redis", "DynamoDB", "Cassandra"] },
  { label: "DevOps", items: ["Docker", "Kubernetes", "Terraform", "Jenkins", "GitHub Actions"] },
];
...
function ServiceOfferingsSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Software Product Architecting Services</h2>
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          End-to-end architecture — from system and cloud design to security, data, and performance — engineered for reliability and growth.
        </p>
      </div>
  ...
  return (
    <div ref={ref} className="border-y border-black/[0.06] dark:border-white/[0.06] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Our Architecting Process</h2>
          <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto">
            From audit and planning through blueprint and validation — a disciplined path to architectures your teams can build and operate with confidence.
          </p>
        </div>
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-black/50 dark:text-white/50 max-w-2xl mx-auto leading-relaxed">
          Cloud platforms, architectural styles, proven backend stacks, data stores, and DevOps tooling — aligned to your scale, compliance, and team strengths.
        </p>
      </div>
...
function WhyChooseSection() {
  ...
  return (
    <div ref={ref} className="mx-auto max-w-7xl px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Cloud Nexus for Architecture</h2>
      </div>
