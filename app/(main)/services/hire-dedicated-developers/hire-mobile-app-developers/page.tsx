...
const techCategories = [
  { label: "Native iOS", items: ["Swift", "SwiftUI", "Objective-C", "Xcode", "TestFlight"] },
  { label: "Native Android", items: ["Kotlin", "Jetpack Compose", "Java", "Android Studio", "Firebase"] },
  { label: "Cross-Platform", items: ["Flutter", "Dart", "React Native", "Expo", "Ionic"] },
  { label: "Backend", items: ["Node.js", "Python", "Go", "GraphQL", "REST APIs"] },
  { label: "DevOps & Cloud", items: ["AWS", "GCP", "Firebase", "Docker", "CI/CD", "Fastlane"] },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className={`text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] transition-all duration-700 delay-100 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Hire Mobile App<br /><span className="text-[#006ea3]">Developers</span></h1>
  ...
  return (
    <div ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 text-center">
        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>Ready to Hire<br /><span className="text-[#006ea3]">Mobile Developers?</span></h2>
        ...
        <div className={`mt-10 flex flex-col sm:flex-row gap-4 justify-center transition-all duration-700 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          <Link href="/resources/free-consultation" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg bg-[#006ea3] text-white font-semibold text-sm hover:bg-[#005580] transition-colors shadow-lg shadow-[#006ea3]/20">Start Hiring <ArrowRight className="w-4 h-4" /></Link>
          <Link href="/our-work" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg border border-black/10 dark:border-white/10 font-semibold text-sm hover:bg-black/[0.03] dark:hover:bg-white/[0.03] transition-colors">View Our Work</Link>
        </div>
      </div>
    </div>
