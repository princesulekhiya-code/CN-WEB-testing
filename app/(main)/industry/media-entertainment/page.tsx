        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-[15px] font-medium text-muted-foreground leading-relaxed">We build OTT streaming platforms, podcast hosting solutions, and content management systems that deliver media to millions of users worldwide. Our architectures handle adaptive bitrate streaming, DRM protection, and real-time viewer analytics at scale.</p>
            </div>
            <div>
              <p className="text-[15px] font-medium text-muted-foreground leading-relaxed mb-6">From multi-CDN delivery strategies and Widevine/FairPlay DRM integration to AI-powered content recommendations and sponsorship marketplaces, we help media companies monetize content and engage audiences across every screen.</p>
