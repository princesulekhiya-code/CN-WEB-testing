        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-[15px] font-medium text-muted-foreground leading-relaxed">We build mobile-first commerce apps and QR-based payment solutions that make buying and selling seamless on smartphones. Our mCommerce platforms feature AR try-on experiences, one-tap checkout, and universal QR payment systems serving millions of users and merchants.</p>
            </div>
            <div>
              <p className="text-[15px] font-medium text-muted-foreground leading-relaxed mb-6">From camera-integrated AR product visualization and biometric-authenticated express payments to merchant self-onboarding in under 5 minutes and offline transaction support for rural areas, we help businesses capture the mobile commerce opportunity.</p>
