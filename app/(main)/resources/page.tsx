...
export default function ResourcesPage() {
  return (
    <section className="min-h-screen bg-white text-black dark:bg-black dark:text-white">
                  ...
                  <div className={`group h-full rounded-2xl border border-black/[0.08] dark:border-white/[0.08] ${resource.borderAccent} bg-white dark:bg-white/[0.02] overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-black/[0.06] dark:hover:shadow-black/40 hover:-translate-y-1 flex flex-col`}>
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <div className="pt-4 border-t border-black/[0.05] dark:border-white/[0.05] flex items-center justify-between">
                        <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#4EB3E8] group-hover:gap-2.5 transition-all">Explore <ArrowRight className="w-4 h-4" /></span>
      ...
      <div className="border-t border-black/[0.05] dark:border-white/[0.05] bg-[#fafafa] dark:bg-white/[0.01]">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Industries we <span className="text-[#4EB3E8]">serve</span></h2>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Our technology stack</h2>
          <p className="mt-1.5 text-sm text-black/45 dark:text-white/40 max-w-xl mx-auto">We use modern, battle-tested technologies to build fast, secure, and scalable applications.</p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }} className="hidden lg:block">
            <div className="grid grid-cols-2 gap-4">
              {[
                { num: "6", unit: "weeks", label: "Average MVP delivery time" },
                { num: "98%", unit: "", label: "On-time project delivery rate" },
                { num: "40%", unit: "", label: "Average cost savings vs in-house" },
                { num: "4.9", unit: "/5", label: "Client satisfaction rating" },
              ].map((m, i) => (
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 relative">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Trusted by teams building the future</h2>
            <p className="mt-2 text-sm text-black/45 dark:text-white/40 max-w-lg mx-auto">Real feedback from founders, CTOs, and product leaders we&apos;ve partnered with.</p>
          </motion.div>
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.1 }}>
                <div className="group h-full rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-white dark:bg-white/[0.02] p-7 flex flex-col relative overflow-hidden hover:border-[#4EB3E8]/15 hover:shadow-xl hover:shadow-[#4EB3E8]/[0.03] transition-all duration-300">
                  ...
                  <div className="flex items-center gap-3 mb-5">
                    <div className={`w-12 h-12 rounded-full ${t.color} flex items-center justify-center flex-shrink-0 shadow-lg`}>
                      <span className="text-sm font-bold text-white">{t.initials}</span>
                    </div>
                    <div>
                      <p className="text-sm font-bold">{t.author}</p>
                      <p className="text-[11px] text-black/45 dark:text-white/35">{t.role}, {t.company}</p>
                    </div>
                  </div>
                  ...
                  <p className="text-[13px] text-black/60 dark:text-white/50 leading-[1.8] flex-1">&ldquo;{t.quote}&rdquo;</p>
                  ...
                  <div className="mt-5 pt-4 border-t border-black/[0.05] dark:border-white/[0.05] flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-black/25 dark:text-white/20 font-medium">{t.company}</span>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <div className="border-t border-black/[0.05] dark:border-white/[0.05] bg-[#fafafa] dark:bg-white/[0.01]">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight">What sets us <span className="text-[#4EB3E8]">apart</span></h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.08 }}>
              <div className="rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-white dark:bg-white/[0.02] p-7 h-full">
                <h3 className="text-lg font-bold mb-3">Transparent Pricing, No Surprises</h3>
                <p className="text-sm text-black/55 dark:text-white/45 leading-relaxed">
                  We believe in complete pricing transparency. Before writing a single line of code, you&apos;ll receive a detailed breakdown of costs, timelines, and deliverables. We don&apos;t pad estimates or add hidden charges. If scope changes during the project, we discuss it openly and adjust the plan together. Our clients always know exactly what they&apos;re paying for.
                </p>
              </div>
            </motion.div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-black/35 dark:text-white/30 mb-1">Email</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-black/35 dark:text-white/30 mb-1">Phone</p>
                      <a href="tel:+918793830447" className="text-sm font-semibold hover:text-[#4EB3E8] transition-colors">+91 87938 30447</a>
                      <p className="text-xs text-black/40 dark:text-white/35 mt-0.5">Mon–Sat, 9AM–7PM IST</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-black/35 dark:text-white/30 mb-1">Quick Connect</p>
                      <Link href="/resources/contact" className="text-sm font-semibold hover:text-[#4EB3E8] transition-colors">Contact Form</Link>
                      <br />
                      <Link href="/resources/free-consultation" className="text-xs text-black/40 dark:text-white/35 hover:text-[#4EB3E8] transition-colors">Book a Call</Link>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-[#fafafa] dark:bg-white/[0.01]">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Why choose Cloud Nexus?</h2>
      ...
      <div className="border-t border-black/[0.05] dark:border-white/[0.05]">
        <div className="mx-auto max-w-4xl px-6 py-16">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
            ...
            <p className="mt-1.5 text-sm text-black/45 dark:text-white/40">Quick answers to common questions about working with Cloud Nexus.</p>
          </motion.div>
      ...
      <div className="border-t border-black/[0.05] dark:border-white/[0.05]">
        <div className="mx-auto max-w-3xl px-6 py-20 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <p className="mt-4 text-xs text-black/30 dark:text-white/25">work@cloudnexus.in &middot; +91 87938 30447</p>
          </motion.div>
        </div>
      </div>
    </section>
